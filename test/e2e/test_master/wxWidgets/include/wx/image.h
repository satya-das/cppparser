...
#    if  wxUSE_STREAMS
  ...
  virtual bool LoadFile(wxImage*, wxInputStream&, bool = true, int = -1)
  {
    return false;
  }
  virtual bool SaveFile(wxImage*, wxOutputStream&, bool = true)
  {
    return false;
  }
...
public:
  ...
  bool FindFirstUnusedColour(unsigned char* r, unsigned char* g, unsigned char* b, unsigned char r2 = 1, unsigned char g2 = 0, unsigned char b2 = 0) const
  {
...
#    endif
  ...
  wxImage Size(const wxSize& size, const wxPoint& pos, int r = -1, int g = -1, int b = -1) const;
...
WXDLLIMPEXP_CORE extern wxImage wxNullImage;
//-----------------------------------------------------------------------------
// wxImage handlers
//-----------------------------------------------------------------------------
