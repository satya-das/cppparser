...
public:
  ...
  static wxString Translate(const wxString& text, wxTextFileType type = typeDefault);
...
#  if  wxUSE_TEXTBUFFER
  ...
  {
    return ++m_nCurLine == m_aLines.size() ? ms_eof : m_aLines[m_nCurLine];
  }
...
protected:
 ...
 ReadAccess, WriteAccess
  ...
  static wxString ms_eof;
  wxString m_strBufferName;
private:
  wxArrayLinesType m_aTypes;
  wxArrayString m_aLines;
  size_t m_nCurLine;
  bool m_isOpened;
#  endif
