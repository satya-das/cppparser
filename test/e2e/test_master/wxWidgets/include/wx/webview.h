...
WXDLLIMPEXP_WEBVIEW extern const char wxWebViewNameStr[];
WXDLLIMPEXP_WEBVIEW extern const char wxWebViewDefaultURLStr[];
WXDLLIMPEXP_WEBVIEW extern const char wxWebViewBackendDefault[];
WXDLLIMPEXP_WEBVIEW extern const char wxWebViewBackendIE[];
WXDLLIMPEXP_WEBVIEW extern const char wxWebViewBackendEdge[];
WXDLLIMPEXP_WEBVIEW extern const char wxWebViewBackendWebKit[];
...
public:
  ...
  virtual bool Create(wxWindow* parent, wxWindowID id, const wxString& url = wxASCII_STR(wxWebViewDefaultURLStr), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = 0, const wxString& name = wxASCII_STR(wxWebViewNameStr)) = 0;
  ...
  static wxWebView* New(wxWindow* parent, wxWindowID id, const wxString& url = wxASCII_STR(wxWebViewDefaultURLStr), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, const wxString& backend = wxASCII_STR(wxWebViewBackendDefault), long style = 0, const wxString& name = wxASCII_STR(wxWebViewNameStr));
...
typedef void (*wxWebViewEventFunction) (wxWebViewEvent&);
