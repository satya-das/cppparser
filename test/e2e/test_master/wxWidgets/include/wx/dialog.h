...
WXDLLIMPEXP_CORE extern const char wxDialogNameStr[];
...
#  if  wxUSE_STATTEXT // && wxUSE_TEXTCTRL
  ...
  wxSizer* CreateTextSizer(const wxString& message, wxTextSizerWrapper& wrapper, int widthMax = -1);
#  endif
...
typedef void (*wxWindowModalDialogEventFunction) (wxWindowModalDialogEvent&);
