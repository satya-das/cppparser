...
inline wxString wxGetDialogClassDescription(const wxClassInfo* ci, const std::type_info& ti)
{
...
template <>
class wxExpectModal<wxMessageDialog> : public wxExpectDismissableModal<wxMessageDialog>
{
public:
