...
class WXDLLIMPEXP_PROPGRID wxPropertyGridPage : public wxEvtHandler, public wxPropertyGridInterface, public wxPropertyGridPageState
{
...
class WXDLLIMPEXP_PROPGRID wxPropertyGridManager : public wxPanel, public wxPropertyGridInterface
{
...
#    endif
  ...
  bool CommitChangesFromEditor(wxUint32 flags = 0)
  {
    ...
    // this is called.
  bool Create(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxPGMAN_DEFAULT_STYLE, const wxString& name = wxASCII_STR(wxPropertyGridManagerNameStr));
...
protected:
  ...
  wxPropertyGridPageState* GetPageState(int page) const override;
public:
...
#    endif
  ...
  bool m_onSplitter;
  bool m_showHeader;
  wxPGProperty* DoGetPropertyByName(const wxString& name) const override;
    // Select and displays a given page.
...
/*#ifdef __WXMSW__
  ...
  void RepaintDescBoxDecorations(wxDC& dc, int newSplitterY, int newWidth, int newHeight);
