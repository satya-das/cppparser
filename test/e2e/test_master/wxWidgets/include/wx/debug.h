...
// conditions
WXDLLIMPEXP_BASE extern wxAssertHandler_t wxTheAssertHandler;
/*
...
// we need
WXDLLIMPEXP_BASE extern void wxOnAssert(const wxChar* file, int line, const char* func, const wxChar* cond, const wxChar* msg = NULL);
...
WXDLLIMPEXP_BASE extern void wxOnAssert(const wxString& file, int line, const wxString& func, const wxString& cond, const wxString& msg);
WXDLLIMPEXP_BASE extern void wxOnAssert(const wxString& file, int line, const wxString& func, const wxString& cond);
WXDLLIMPEXP_BASE extern void wxOnAssert(const char* file, int line, const char* func, const char* cond, const wxCStrData& msg);
WXDLLIMPEXP_BASE extern void wxOnAssert(const char* file, int line, const char* func, const char* cond, const wxString& msg);
#  endif
// ----------------------------------------------------------------------------
// Debugging macros
// ----------------------------------------------------------------------------
...
WXDLLIMPEXP_BASE extern void wxTrap();
#    endif
...
WXDLLIMPEXP_BASE extern bool wxTrapInAssert;
...
// constant expression
WXDLLIMPEXP_BASE extern const bool wxFalse;
