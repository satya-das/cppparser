...
private:
  ...
  bool m_closed;
  wxUint32 m_lcount;
  wxUint32 m_lcount_read;
  wxUint32 m_lcount_write;
  ...
  wxSocketEventFlags m_eventsgot;
...
public:
  ...
  bool Connect(const wxSockAddress& addr, const wxSockAddress& local, bool wait = true);
...
public:
  ...
  wxDatagramSocket& RecvFrom(wxSockAddress& addr, void* buf, wxUint32 nBytes);
  wxDatagramSocket& SendTo(const wxSockAddress& addr, const void* buf, wxUint32 nBytes);
    /* TODO:
