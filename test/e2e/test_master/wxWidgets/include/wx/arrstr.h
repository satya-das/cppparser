...
inline int wxCMPFUNC_CONV wxDictionaryStringSortDescending(const wxString& s1, const wxString& s2)
{
...
WXDLLIMPEXP_BASE int wxCMPFUNC_CONV wxCmpNaturalGeneric(const wxString& s1, const wxString& s2);
...
public:
  ...
  {
    return const_cast<wxArrayString*>(this)->Item(nIndex);
  }
    // same as Item()
  ...
  {
    return const_cast<wxArrayString*>(this)->Last();
  }
  // item management
  ...
  public:
    ...
    reverse_iterator(const itor& it)
      : m_ptr(it.m_ptr)
    {
    }
  ...
  public:
    ...
    const_reverse_iterator(const itor& it)
      : m_ptr(it.m_ptr)
    {
    }
  ...
  wxArrayString(size_type n, const_reference v)
  {
    Init(false);
    assign(n, v);
  }
...
// passing '\0' as escape
WXDLLIMPEXP_BASE wxString wxJoin(const wxArrayString& arr, const wxChar sep, const wxChar escape = wxT('\\'));
WXDLLIMPEXP_BASE wxArrayString wxSplit(const wxString& str, const wxChar sep, const wxChar escape = wxT('\\'));
// ----------------------------------------------------------------------------
