...
{
public:
  wxAnyValueTypeScopedPtr(wxAnyValueType* ptr)
    : m_ptr(ptr)
  {
  }
...
public:
  ...
  void CopyBuffer(const wxAnyValueBuffer& src, wxAnyValueBuffer& dst) const override
  {
...
public:
  ...
  bool ConvertValue(const wxAnyValueBuffer& src, wxAnyValueType* dstType, wxAnyValueBuffer& dst) const override
  {
    wxUnusedVar(src);
    wxUnusedVar(dstType);
    wxUnusedVar(dst);
...
#    endif
class WXDLLIMPEXP_BASE wxAnyValueTypeImplInt : public wxAnyValueTypeImplBase<wxAnyBaseIntType>
{
...
class WXDLLIMPEXP_BASE wxAnyValueTypeImplUint : public wxAnyValueTypeImplBase<wxAnyBaseUintType>
{
...
WXDLLIMPEXP_BASE extern bool wxAnyConvertString(const wxString& value, wxAnyValueType* dstType, wxAnyValueBuffer& dst);
...
WX_ANY_DEFINE_CONVERTIBLE_TYPE(const wchar_t*, ConstWchar_tPtr,
                               wxAnyConvertString, wxString)
template <>
class WXDLLIMPEXP_BASE wxAnyValueTypeImpl<bool> : public wxAnyValueTypeImplBase<bool>
{
...
//
class WXDLLIMPEXP_BASE wxAnyValueTypeImplDouble : public wxAnyValueTypeImplBase<double>
{
...
//
class WXDLLIMPEXP_BASE wxAnyValueTypeImplVariantData : public wxAnyValueTypeImplBase<wxVariantData*>
{
...
public:
  ...
  static void SetValue(wxVariantData* value, wxAnyValueBuffer& buf)
  {
    value->IncRef();
    buf.m_ptr = value;
  }
...
template <>
class wxAnyValueTypeImpl<wxVariantData*> : public wxAnyValueTypeImplVariantData
{
public:
  wxAnyValueTypeImpl()
    : wxAnyValueTypeImplVariantData()
...
*/
WXDLLIMPEXP_BASE extern wxAnyValueType* wxAnyNullValueType;
//
...
WXDLLIMPEXP_BASE extern void wxPreRegisterAnyToVariant(wxAnyToVariantRegistration* reg);
// This function performs main wxAny to wxVariant conversion duties.
WXDLLIMPEXP_BASE extern bool wxConvertAnyToVariant(const wxAny& any, wxVariant* variant);
#    endif
//
...
#    endif
  bool operator==(float value) const
  {
    ...
    return value == static_cast<float>(wxAnyValueTypeImpl<float>::GetValue(m_buffer));
  }
  bool operator==(double value) const
  {
    ...
    return value == static_cast<double>(wxAnyValueTypeImpl<double>::GetValue(m_buffer));
  }
...
#    endif
  ...
  bool GetAs(T* value) const
  {
    if (!wxAnyValueTypeImpl<T>::IsSameClass(m_type))
    {
      wxAnyValueType* otherType = wxAnyValueTypeImpl<T>::sm_instance.get();
      wxAnyValueBuffer temp_buf;
      if (!m_type->ConvertValue(m_buffer, otherType, temp_buf))
      {
        return false;
      }
      *value = static_cast<T>(wxAnyValueTypeImpl<T>::GetValue(temp_buf));
