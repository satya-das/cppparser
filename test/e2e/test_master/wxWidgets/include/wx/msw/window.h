...
public:
 ...
 Init();
  ...
  bool CreateUsingMSWClass(const wxChar* classname, wxWindow* parent, wxWindowID id, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = 0, const wxString& name = wxASCII_STR(wxPanelNameStr));
...
#  endif
  ...
  wxCoord AdjustForLayoutDirection(wxCoord x, wxCoord width, wxCoord widthTotal) const override;
...
#  endif
 ...
 return MSWGetStyle(GetWindowStyle(), exflags);
  ...
  bool MSWCreate(const wxChar* wclass, const wxChar* title = NULL, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, WXDWORD style = 0, WXDWORD exendedStyle = 0);
...
#  endif
  ...
  virtual void SetupColours();
    ...
    // ------------------------------------------------------------------------
  void UnpackCommand(WXWPARAM wParam, WXLPARAM lParam, WXWORD* id, WXHWND* hwnd, WXWORD* cmd);
  void UnpackActivate(WXWPARAM wParam, WXLPARAM lParam, WXWORD* state, WXWORD* minimized, WXHWND* hwnd);
  void UnpackScroll(WXWPARAM wParam, WXLPARAM lParam, WXWORD* code, WXWORD* pos, WXHWND* hwnd);
  void UnpackCtlColor(WXWPARAM wParam, WXLPARAM lParam, WXHDC* hdc, WXHWND* hwnd);
  void UnpackMenuSelect(WXWPARAM wParam, WXLPARAM lParam, WXWORD* item, WXWORD* flags, WXHMENU* hmenu);
    // ------------------------------------------------------------------------
  ...
  virtual bool MSWOnScroll(int orientation, WXWORD nSBCode, WXWORD pos, WXHWND control);
  ...
  bool HandleMouseWheel(wxMouseWheelAxis axis, WXWPARAM wParam, WXLPARAM lParam);
...
#  endif
 ...
 return NULL;
  ...
  wxColour MSWGetThemeColour(const wchar_t* themeName, int themePart, int themeState, MSWThemeColour themeColour, wxSystemColour fallback) const;
...
#  endif
  ...
  virtual void WXSetPendingFocus(wxWindow*)
  {
  }
...
#  if  wxUSE_TOOLTIPS
  ...
  bool HandleTooltipNotify(WXUINT code, WXLPARAM lParam, const wxString& ttip);
#  endif
  ...
  void InitAnyKeyEvent(wxKeyEvent& event, WXWPARAM wParam, WXLPARAM lParam) const;
  ...
  wxKeyEvent CreateKeyEvent(wxEventType evType, WXWPARAM wParam, WXLPARAM lParam = 0) const;
  ...
  wxKeyEvent CreateCharEvent(wxEventType evType, WXWPARAM wParam, WXLPARAM lParam) const;
  ...
  virtual void MSWGetCreateWindowCoords(const wxPoint& pos, const wxSize& size, int& x, int& y, int& w, int& h) const;
...
#  endif
  static bool MSWIsPositionDirectlySupported(int x, int y)
  {
