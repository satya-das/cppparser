...
WXDLLIMPEXP_CORE extern bool wxEntryStart(HINSTANCE hInstance, HINSTANCE hPrevInstance = NULL, wxCmdLineArgType pCmdLine = NULL, int nCmdShow = SW_SHOWNORMAL);
WXDLLIMPEXP_CORE extern int wxEntry(HINSTANCE hInstance, HINSTANCE hPrevInstance = NULL, wxCmdLineArgType pCmdLine = NULL, int nCmdShow = SW_SHOWNORMAL);
#    define wxIMPLEMENT_WXWIN_MAIN	extern "C" int WINAPI WinMain(HINSTANCE hInstance,                      \
