...
protected:
  ...
  bool CreateAndInit(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, int n, const wxString choices[], long style, const wxValidator& validator, const wxString& name);
...
#  endif
  ...
  int m_lastAcceptedSelection, m_pendingSelection;
