...
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_CORE wxBitmap : public wxGDIImage, public wxBitmapHelpers
{
public:
...
#  endif
  ...
  wxBitmap(const wxIcon& icon, wxBitmapTransparency transp = wxBitmapTransparency_Auto)
  {
...
#  endif
  ...
  bool CopyFromIcon(const wxIcon& icon, wxBitmapTransparency transp = wxBitmapTransparency_Auto);
    // copies the contents and mask of the given cursor to the bitmap
  bool CopyFromCursor(const wxCursor& cursor, wxBitmapTransparency transp = wxBitmapTransparency_Auto);
#  if  wxUSE_WXDIB
...
private:
  ...
  bool CopyFromIconOrCursor(const wxGDIImage& icon, wxBitmapTransparency transp = wxBitmapTransparency_Auto);
...
public:
 ...
 m_maskBitmap = hbmp;   }
  ...
  { return m_maskBitmap; }
  void SetMaskBitmap(WXHBITMAP bmp)
  { m_maskBitmap = bmp; }
protected:
...
public:
  ...
  bool Create(wxGDIImage* image, const void* data, wxBitmapType type, int width, int height, int depth = 1) override;
  bool Load(wxGDIImage* image, const wxString& name, wxBitmapType type, int desiredWidth, int desiredHeight) override;
  bool Save(const wxGDIImage* image, const wxString& name, wxBitmapType type) const override;
