...
typedef bool (*wxObjectStreamingCallback) (const wxObject*, wxObjectWriter*, wxObjectWriterCallback*, const wxStringToAnyHashMap&);
...
public:
  ...
  bool BeforeWriteObject(const wxObject* obj, wxObjectWriter* streamer, wxObjectWriterCallback* writercallback, const wxStringToAnyHashMap& metadata) const;
  ...
  virtual wxAnyList GetPropertyCollection(wxObject* object, const wxChar* propertyName) const;
  virtual void AddToPropertyCollection(wxObject* object, const wxChar* propertyName, const wxAny& value) const;
