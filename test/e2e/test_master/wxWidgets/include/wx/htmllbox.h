...
WXDLLIMPEXP_HTML extern const char wxHtmlListBoxNameStr[];
WXDLLIMPEXP_HTML extern const char wxSimpleHtmlListBoxNameStr[];
// ----------------------------------------------------------------------------
// wxHtmlListBox
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_HTML wxHtmlListBox : public wxVListBox, public wxHtmlWindowInterface, public wxHtmlWindowMouseHelper
{
...
public:
  ...
  wxHtmlListBox(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = 0, const wxString& name = wxASCII_STR(wxHtmlListBoxNameStr));
  ...
  bool Create(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = 0, const wxString& name = wxASCII_STR(wxHtmlListBoxNameStr));
...
private:
  ...
  wxPoint HTMLCoordsToWindow(wxHtmlCell* cell, const wxPoint& pos) const override;
...
class WXDLLIMPEXP_HTML wxSimpleHtmlListBox : public wxWindowWithItems<wxHtmlListBox, wxItemContainer>
{
