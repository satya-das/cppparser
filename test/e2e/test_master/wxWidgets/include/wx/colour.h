...
#    define wxWXCOLOUR_CTOR_FROM_CHAR	wxColour(const char *colourName) { Init(); Set(colourName); }
#  else 
#    define wxWXCOLOUR_CTOR_FROM_CHAR
#  endif
#  define DEFINE_STD_WXCOLOUR_CONSTRUCTORS	wxColour() { Init(); }                                                    \
...
#  endif
class WXDLLIMPEXP_CORE wxColourBase : public wxGDIObject
{
public:
  ...
  void Set(unsigned long colRGB)
  {
    ...
    Set((ChannelType) (0xFF & colRGB), (ChannelType) (0xFF & (colRGB >> 8)), (ChannelType) (0xFF & (colRGB >> 16)));
  }
    // accessors
    // ---------
  ...
  {
    Set((ChannelType) (0xFF & colRGBA), (ChannelType) (0xFF & (colRGBA >> 8)), (ChannelType) (0xFF & (colRGBA >> 16)), (ChannelType) (0xFF & (colRGBA >> 24)));
  }
...
protected:
  ...
  virtual void InitRGBA(ChannelType r, ChannelType g, ChannelType b, ChannelType a) = 0;
