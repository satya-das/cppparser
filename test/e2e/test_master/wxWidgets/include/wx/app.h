...
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_BASE wxAppConsoleBase : public wxEvtHandler, public wxEventFilter
{
public:
    // ctor and dtor
  wxAppConsoleBase();
...
#  if  wxUSE_EXCEPTIONS
    ...
    // of wxEvtHandler)
  virtual void CallEventHandler(wxEvtHandler* handler, wxEventFunctor& functor, wxEvent& event) const;
...
#    ifdef __VISUALC__
#      define wxIMPLEMENT_WXWIN_MAIN_CONSOLE	int wmain(int argc, wchar_t **argv)                               \
            {                                                                 \
...
#    else 
#      define wxIMPLEMENT_WXWIN_MAIN_CONSOLE	int main(int, char **)                                            \
            {                                                                 \
                wxDISABLE_DEBUG_SUPPORT();                                    \
                                                                              \
                return wxEntry();                                             \
...
#    endif
#  else 
#    define wxIMPLEMENT_WXWIN_MAIN_CONSOLE	int main(int argc, char **argv)                                       \
        {                                                                     \
            wxDISABLE_DEBUG_SUPPORT();                                        \
                                                                              \
            return wxEntry(argc, argv);                                       \
...
#      define wxIMPLEMENT_WX_THEME_SUPPORT	WX_USE_THEME(wxUNIV_DEFAULT_THEME);
#    else 
