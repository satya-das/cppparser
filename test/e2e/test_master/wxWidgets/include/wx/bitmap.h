...
protected:
  ...
  virtual bool InitFromColour(const wxBitmap& bitmap, const wxColour& colour) = 0;
...
public:
  ...
  virtual bool Create(wxBitmap*, const void*, wxBitmapType, int, int, int = 1)
  {
    return false;
  }
  virtual bool LoadFile(wxBitmap*, const wxString&, wxBitmapType, int, int)
  {
    return false;
  }
  virtual bool SaveFile(const wxBitmap*, const wxString&, wxBitmapType, const wxPalette* = NULL) const
  {
    return false;
  }
...
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_CORE wxBitmapBase : public wxGDIObject, public wxBitmapHelpers
{
public:
    /*
