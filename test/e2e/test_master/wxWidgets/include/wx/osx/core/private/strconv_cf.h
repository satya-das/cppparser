...
inline CFStringEncoding wxCFStringEncFromFontEnc(wxFontEncoding encoding)
{
  ...
  switch(encoding)
  {
    ...
    case wxFONTENCODING_KOI8:
      ...
      break;
    case wxFONTENCODING_ALTERNATIVE:
...
public:
  ...
  bool IsOk() const
  {
    return m_encoding != kCFStringEncodingInvalidId && CFStringIsEncodingAvailable(m_encoding);
  }
private:
...
{
public:
  wxMBConvD_cf(wxFontEncoding encoding)
    : wxMBConv_cf(encoding, (NormalizationForm) (ToWChar_C | FromWChar_D))
  {
  }
};
