...
public:
  ...
  bool ShouldProcessIdleEvents() const
  {
    return m_processIdleEvents;
  }
#  if  wxUSE_UIACTIONSIMULATOR
  ...
  void SetShouldWaitForEvent(bool should)
  {
    m_shouldWaitForEvent = should;
  }
#  endif
protected:
  ...
  void SetProcessIdleEvents(bool process)
  {
    m_processIdleEvents = process;
  }
