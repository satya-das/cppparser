...
public:
  ...
  virtual WXWidget GetWXWidget() const
  {
    return m_osxView;
  }
  ...
  bool ButtonClickDidStateChange()
  {
    return true;
  }
...
public:
  ...
  void Create(wxWindow* parent, const wxPoint& pos, const wxSize& size, long style, long extraStyle, const wxString& name);
  ...
  virtual bool EnableMaximizeButton(bool)
  {
    return false;
  }
  virtual bool EnableMinimizeButton(bool)
  {
    return false;
  }
  ...
  virtual bool InitialShowEventSent()
  {
    return m_initialShowSent;
  }
protected:
