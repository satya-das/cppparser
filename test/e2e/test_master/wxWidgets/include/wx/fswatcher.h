...
enum
{
  ...
  wxFSW_EVENT_ALL = wxFSW_EVENT_CREATE | wxFSW_EVENT_DELETE | wxFSW_EVENT_RENAME | wxFSW_EVENT_MODIFY | wxFSW_EVENT_ACCESS | wxFSW_EVENT_ATTRIB | wxFSW_EVENT_WARNING | wxFSW_EVENT_ERROR,
...
typedef void (*wxFileSystemWatcherEventFunction) (wxFileSystemWatcherEvent&);
...
protected:
  static wxString GetCanonicalPath(const wxFileName& path)
  {
    ...
    {
      wxFAIL_MSG(wxString::Format(wxASCII_STR("Unable to normalize path '%s'"), path.GetFullPath()));
