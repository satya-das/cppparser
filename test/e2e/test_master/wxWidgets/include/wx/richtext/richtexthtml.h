...
// Accessors and operations unique to this handler
  ...
  { m_fontSizeMapping = fontSizeMapping; }
  wxArrayInt GetFontSizeMapping() const
  { return m_fontSizeMapping; }
protected:
// Implementation
#  if  wxUSE_STREAMS
