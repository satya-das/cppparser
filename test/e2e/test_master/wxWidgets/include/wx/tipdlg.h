...
#    if  wxUSE_TEXTFILE
WXDLLIMPEXP_ADV wxTipProvider* wxCreateFileTipProvider(const wxString& filename, size_t currentTip);
#    endif
// ----------------------------------------------------------------------------
// wxTipDialog
// ----------------------------------------------------------------------------
...
WXDLLIMPEXP_ADV bool wxShowTip(wxWindow* parent, wxTipProvider* tipProvider, bool showAtStartup = true);
#  endif
#endif
