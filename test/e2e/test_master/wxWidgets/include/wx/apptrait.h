...
#  endif
  ...
  virtual wxPortId GetToolkitVersion(int* majVer = NULL, int* minVer = NULL, int* microVer = NULL) const = 0;
...
#  endif
  ...
  wxPortId GetToolkitVersion(int* verMaj = NULL, int* verMin = NULL, int* verMicro = NULL) const override
  {
