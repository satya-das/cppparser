...
protected:
  ...
  wxVariant CheckedGetValue(const wxDataViewModel* model, const wxDataViewItem& item, unsigned column) const;
...
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_CORE wxDataViewCustomRendererBase : public wxDataViewCustomRendererRealBase
{
public:
...
class WXDLLIMPEXP_CORE wxDataViewCheckIconTextRenderer : public wxDataViewCustomRenderer
{
public:
  static wxString GetDefaultType()
  {
...
#    endif
  wxSize GetSize() const override;
  bool Render(wxRect cell, wxDC* dc, int state) override;
  bool ActivateCell(const wxRect& cell, wxDataViewModel* model, const wxDataViewItem& item, unsigned int col, const wxMouseEvent* mouseEvent) override;
private:
