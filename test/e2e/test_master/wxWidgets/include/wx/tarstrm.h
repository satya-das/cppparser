...
public:
  ...
  wxTarEntry* Clone() const
  {
    return new wxTarEntry(*this);
  }
  void SetNotifier(wxTarNotifier&)
  {
  }
private:
...
public:
  ...
  bool PutNextEntry(const wxString& name, const wxDateTime& dt = wxDateTime::Now(), wxFileOffset size = wxInvalidOffset) override;
  bool PutNextDirEntry(const wxString& name, const wxDateTime& dt = wxDateTime::Now()) override;
  bool CopyEntry(wxTarEntry* entry, wxTarInputStream& inputStream);
  bool CopyArchiveMetaData(wxTarInputStream&)
  {
    return true;
  }
  void Sync() override;
...
private:
  ...
  bool CopyArchiveMetaData(wxArchiveInputStream&) override
  {
    return true;
  }
  bool IsOpened() const
  ...
  wxFileOffset m_pos;
  wxFileOffset m_maxpos;
  wxFileOffset m_size;
  wxFileOffset m_headpos;
  wxFileOffset m_datapos;
  wxFileOffset m_tarstart;
  wxFileOffset m_tarsize;
  bool m_pax;
...
typedef wxArchiveIterator<wxTarInputStream, std::pair<wxString, wxTarEntry*> > wxTarPairIter;
#    endif
/////////////////////////////////////////////////////////////////////////////
// wxTarClassFactory
