...
#    endif
WXDLLIMPEXP_CORE extern const char wxDataViewCtrlNameStr[];
// ----------------------------------------------------------------------------
...
public:
  ...
  { return m_colour; }
  bool HasFont() const
  { return m_bold || m_italic || m_strikethrough; }
  bool GetBold() const
  { return m_bold; }
  ...
  { return m_bgColour.IsOk(); }
  const wxColour& GetBackgroundColour() const
  { return m_bgColour; }
  bool IsDefault() const
  { return !(HasColour() || HasFont() || HasBackgroundColour()); }
...
public:
  ...
  virtual bool GetAttr(const wxDataViewItem&, unsigned int, wxDataViewItemAttr&) const
  {
        return false;
    }
    // Override this if you want to disable specific items
  virtual bool IsEnabled(const wxDataViewItem&, unsigned int) const
  {
        return true;
    }
    // define hierarchy
...
protected:
  ...
  virtual int DoCompareValues(const wxVariant&, const wxVariant&) const
  {
        return 0;
    }
private:
...
public:
  ...
  virtual bool IsEnabledByRow(unsigned int, unsigned int) const
  {
        return true;
    }
...
public:
  ...
  { return m_size; }
    // internal
  bool IsVirtualListModel() const override
  { return true; }
private:
  unsigned int m_size;
};
...
public:
  ...
  wxDataViewColumnBase(wxDataViewRenderer* renderer, unsigned int model_column)
  {
  ...
  virtual int WXGetSpecifiedWidth() const
  { return GetWidth(); }
protected:
...
public:
  ...
  wxDataViewColumn* PrependToggleColumn(const wxString& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_TOGGLE_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  wxDataViewColumn* PrependProgressColumn(const wxString& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  ...
  wxDataViewColumn* PrependToggleColumn(const wxBitmap& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_TOGGLE_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  wxDataViewColumn* PrependProgressColumn(const wxBitmap& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  ...
  wxDataViewColumn* AppendToggleColumn(const wxString& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_TOGGLE_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  wxDataViewColumn* AppendProgressColumn(const wxString& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  ...
  wxDataViewColumn* AppendToggleColumn(const wxBitmap& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_TOGGLE_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  wxDataViewColumn* AppendProgressColumn(const wxBitmap& label, unsigned int model_column, wxDataViewCellMode mode = wxDATAVIEW_CELL_INERT, int width = wxDVC_DEFAULT_WIDTH, wxAlignment align = wxALIGN_CENTER, int flags = wxDATAVIEW_COL_RESIZABLE);
  ...
  virtual void ToggleSortByColumn(int)
  { }
    // items management
    // ----------------
  ...
  virtual bool SetRowHeight(int)
  { return false; }
  virtual void EditItem(const wxDataViewItem& item, const wxDataViewColumn* column) = 0;
    // Use EditItem() instead
#    if  wxUSE_DRAG_AND_DROP
  virtual bool EnableDragSource(const wxDataFormat&)
  { return false; }
  virtual bool EnableDropTarget(const wxDataFormat&)
  { return false; }
#    endif
  ...
  { return false; }
    ...
    // indicate it.
  virtual bool SetAlternateRowColour(const wxColour&)
  { return false; }
...
public:
  ...
  wxDataViewEvent(wxEventType evtType, wxDataViewCtrlBase* dvc, wxDataViewColumn* column, const wxDataViewItem& item = wxDataViewItem())
...
#    if  wxUSE_DRAG_AND_DROP
  ...
  { m_proposedDropIndex = index; }
  int GetProposedDropIndex() const
  { return m_proposedDropIndex;}
#    endif
  wxEvent* Clone() const override
  { return new wxDataViewEvent(*this); }
...
#    if  WXWIN_COMPATIBILITY_3_0
  wxDEPRECATED_MSG("Pass the argument to the ctor instead") void SetModel(wxDataViewModel* model)
  { m_model = model; }
  wxDEPRECATED_MSG("Pass the argument to the ctor instead") void SetDataViewColumn(wxDataViewColumn* col)
  { m_column = col; }
  wxDEPRECATED_MSG("Pass the argument to the ctor instead") void SetItem(const wxDataViewItem& item)
  { m_item = item; }
#    endif
...
private:
  ...
  void Init(wxDataViewCtrlBase* dvc, wxDataViewColumn* column, const wxDataViewItem& item);
...
typedef void (*wxDataViewEventFunction) (wxDataViewEvent&);
...
{
public:
  wxDataViewTreeStoreContainerNode(wxDataViewTreeStoreNode* parent, const wxString& text, const wxIcon& icon = wxNullIcon, const wxIcon& expanded = wxNullIcon, wxClientData* data = NULL);
...
//-----------------------------------------------------------------------------
class WXDLLIMPEXP_CORE wxDataViewTreeCtrl : public wxDataViewCtrl, public wxWithImages
{
public:
  wxDataViewTreeCtrl()
  {
  ...
  wxDataViewItem AppendItem(const wxDataViewItem& parent, const wxString& text, int icon = NO_IMAGE, wxClientData* data = NULL);
  wxDataViewItem PrependItem(const wxDataViewItem& parent, const wxString& text, int icon = NO_IMAGE, wxClientData* data = NULL);
  wxDataViewItem InsertItem(const wxDataViewItem& parent, const wxDataViewItem& previous, const wxString& text, int icon = NO_IMAGE, wxClientData* data = NULL);
  wxDataViewItem PrependContainer(const wxDataViewItem& parent, const wxString& text, int icon = NO_IMAGE, int expanded = NO_IMAGE, wxClientData* data = NULL);
  wxDataViewItem AppendContainer(const wxDataViewItem& parent, const wxString& text, int icon = NO_IMAGE, int expanded = NO_IMAGE, wxClientData* data = NULL);
  wxDataViewItem InsertContainer(const wxDataViewItem& parent, const wxDataViewItem& previous, const wxString& text, int icon = NO_IMAGE, int expanded = NO_IMAGE, wxClientData* data = NULL);
  wxDataViewItem GetNthChild(const wxDataViewItem& parent, unsigned int pos) const
