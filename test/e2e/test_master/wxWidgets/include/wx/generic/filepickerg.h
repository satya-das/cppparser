...
//-----------------------------------------------------------------------------
class WXDLLIMPEXP_CORE wxGenericFileDirButton : public wxButton, public wxFileDirPickerWidgetBase
{
public:
...
public:
  ...
  virtual long GetDialogStyle() const
  {
    ...
    wxASSERT_MSG(m_pickerStyle != -1, "forgot to initialize m_pickerStyle?");
    long filedlgstyle = 0;
