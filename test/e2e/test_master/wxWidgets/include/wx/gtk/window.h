...
#  endif
  ...
  bool DoIsExposed(int x, int y) const override;
  bool DoIsExposed(int x, int y, int w, int h) const override;
...
#  endif
  ...
  void DoMoveInTabOrder(wxWindow* win, WindowOrder move) override;
  bool DoNavigateIn(int flags) override;
