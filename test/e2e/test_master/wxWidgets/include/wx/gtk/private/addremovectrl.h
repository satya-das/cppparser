...
#  endif
    ...
    m_tbar->Bind(wxEVT_UPDATE_UI, &wxAddRemoveImplBase::OnUpdateUIAdd, this, wxID_ADD);
    m_tbar->Bind(wxEVT_UPDATE_UI, &wxAddRemoveImplBase::OnUpdateUIRemove, this, wxID_REMOVE);
