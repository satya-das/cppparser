...
public:
  ...
  static wxBitmap GetBitmap(const wxArtID& id, const wxArtClient& client = wxASCII_STR(wxART_OTHER), const wxSize& size = wxDefaultSize);
    // Query the providers for icon with given ID and return it. Return
    // wxNullIcon if no provider provides it.
  static wxIcon GetIcon(const wxArtID& id, const wxArtClient& client = wxASCII_STR(wxART_OTHER), const wxSize& size = wxDefaultSize);
  ...
  static wxIconBundle GetIconBundle(const wxArtID& id, const wxArtClient& client = wxASCII_STR(wxART_OTHER));
...
#  endif
  ...
  virtual wxIconBundle CreateIconBundle(const wxArtID&, const wxArtClient&)
  {
    return wxNullIconBundle;
  }
private:
  static void CommonAddingProvider();
  static wxIconBundle DoGetIconBundle(const wxArtID& id, const wxArtClient& client);
    // list of providers:
