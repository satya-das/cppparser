...
class WXDLLIMPEXP_CORE wxSearchCtrlBaseBaseClass : public wxCompositeWindow< wxNavigationEnabled<wxControl> >, public wxTextCtrlIface
{
};
...
#    elif  defined(__WXGTK20__)
    ...
    // otherwise.
#      define wxUSE_NATIVE_SEARCH_CONTROL	1
class WXDLLIMPEXP_CORE wxGTKSearchCtrlBase : public wxControl, public wxTextEntry
{
};
...
// constants
// ----------------------------------------------------------------------------
WXDLLIMPEXP_CORE extern const char wxSearchCtrlNameStr[];
