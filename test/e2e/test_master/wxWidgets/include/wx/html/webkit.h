...
typedef void (*wxWebKitStateChangedEventFunction) (wxWebKitStateChangedEvent&);
typedef void (*wxWebKitBeforeLoadEventFunction) (wxWebKitBeforeLoadEvent&);
typedef void (*wxWebKitNewWindowEventFunction) (wxWebKitNewWindowEvent&);
