...
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_HTML wxHtmlWindow : public wxScrolledWindow, public wxHtmlWindowInterface, public wxHtmlWindowMouseHelper
{
...
typedef void (*wxHtmlCellEventFunction) (wxHtmlCellEvent&);
typedef void (*wxHtmlLinkEventFunction) (wxHtmlLinkEvent&);
