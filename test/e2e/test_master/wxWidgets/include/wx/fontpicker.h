...
WXDLLIMPEXP_CORE extern const char wxFontPickerWidgetNameStr[];
WXDLLIMPEXP_CORE extern const char wxFontPickerCtrlNameStr[];
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
typedef void (*wxFontPickerEventFunction) (wxFontPickerEvent&);
