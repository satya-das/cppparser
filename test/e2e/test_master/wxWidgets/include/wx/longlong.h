...
#      endif
  ...
  {
    return wxLongLongNative(*this).Abs();
  }
...
#      ifdef wxHAS_LONG_LONG_T_DIFFERENT_FROM_LONG
    wxASSERT_MSG((m_ll >= LONG_MIN) && (m_ll <= LONG_MAX), wxT("wxLongLong to long conversion loss of precision"));
#      endif
  ...
  {
    return wx_truncate_cast(double, m_ll);
  }
...
#      if  wxUSE_STD_IOSTREAM
        // input/output
  WXDLLIMPEXP_BASE friend std::ostream& operator<<(std::ostream&, const wxLongLongNative&);
#      endif
  WXDLLIMPEXP_BASE friend wxString& operator<<(wxString&, const wxLongLongNative&);
#      if  wxUSE_STREAMS
  WXDLLIMPEXP_BASE friend class wxTextOutputStream& operator<<(class wxTextOutputStream&, const wxLongLongNative&);
  WXDLLIMPEXP_BASE friend class wxTextInputStream& operator>>(class wxTextInputStream&, wxLongLongNative&);
#      endif
private:
  wxLongLong_t m_ll;
};
...
#      endif
  ...
  {
    wxASSERT_MSG(m_ll <= ULONG_MAX, wxT("wxULongLong to long conversion loss of precision"));
...
#      if  wxUSE_STD_IOSTREAM
        // input/output
  WXDLLIMPEXP_BASE friend std::ostream& operator<<(std::ostream&, const wxULongLongNative&);
#      endif
  WXDLLIMPEXP_BASE friend wxString& operator<<(wxString&, const wxULongLongNative&);
#      if  wxUSE_STREAMS
  WXDLLIMPEXP_BASE friend class wxTextOutputStream& operator<<(class wxTextOutputStream&, const wxULongLongNative&);
  WXDLLIMPEXP_BASE friend class wxTextInputStream& operator>>(class wxTextInputStream&, wxULongLongNative&);
#      endif
private:
  wxULongLong_t m_ll;
};
inline wxLongLongNative& wxLongLongNative::operator=(const wxULongLongNative& ll)
{
  m_ll = ll.GetValue();
  return *this;
}
...
#      endif
  ...
  unsigned long GetLo() const
  {
    return m_lo;
        ...
        // get absolute value
  wxLongLongWx Abs() const
  {
    return wxLongLongWx(*this).Abs();
  }
  wxLongLongWx& Abs()
  {
    if (m_hi < 0)
...
#      endif
  ...
  long ToLong() const
  {
    wxASSERT_MSG((m_hi == 0l) || (m_hi == -1l), wxT("wxLongLong to long conversion loss of precision"));
    return (long) m_lo;
  }
        // convert to double
  double ToDouble() const;
...
#      endif
  ...
  bool operator==(long l) const
  {
    return l >= 0 ? (m_hi == 0 && m_lo == (unsigned long) l) : (m_hi == -1 && m_lo == (unsigned long) l);
  }
  bool operator<=(long l) const
  {
  ...
  wxLongLongWx& operator/=(const wxLongLongWx& ll);
  wxLongLongWx operator%(const wxLongLongWx& ll) const;
  void Divide(const wxLongLongWx& divisor, wxLongLongWx& quotient, wxLongLongWx& remainder) const;
    // input/output
  ...
  void* asArray() const;
#      if  wxUSE_STD_IOSTREAM
  WXDLLIMPEXP_BASE friend std::ostream& operator<<(std::ostream&, const wxLongLongWx&);
#      endif
  WXDLLIMPEXP_BASE friend wxString& operator<<(wxString&, const wxLongLongWx&);
#      if  wxUSE_STREAMS
  WXDLLIMPEXP_BASE friend class wxTextOutputStream& operator<<(class wxTextOutputStream&, const wxLongLongWx&);
  WXDLLIMPEXP_BASE friend class wxTextInputStream& operator>>(class wxTextInputStream&, wxLongLongWx&);
#      endif
private:
...
#      endif
  ...
  unsigned long ToULong() const
  {
    wxASSERT_MSG(m_hi == 0ul, wxT("wxULongLong to long conversion loss of precision"));
  ...
  wxULongLongWx& operator/=(const wxULongLongWx& ll);
  wxULongLongWx operator%(const wxULongLongWx& ll) const;
  void Divide(const wxULongLongWx& divisor, wxULongLongWx& quotient, wxULongLongWx& remainder) const;
    // input/output
  ...
  void* asArray() const;
#      if  wxUSE_STD_IOSTREAM
  WXDLLIMPEXP_BASE friend std::ostream& operator<<(std::ostream&, const wxULongLongWx&);
#      endif
  WXDLLIMPEXP_BASE friend wxString& operator<<(wxString&, const wxULongLongWx&);
#      if  wxUSE_STREAMS
  WXDLLIMPEXP_BASE friend class wxTextOutputStream& operator<<(class wxTextOutputStream&, const wxULongLongWx&);
  WXDLLIMPEXP_BASE friend class wxTextInputStream& operator>>(class wxTextInputStream&, wxULongLongWx&);
#      endif
private:
    // long is at least 32 bits, so represent our 64bit number as 2 longs
  unsigned long m_hi;
...
// binary operators
// ----------------------------------------------------------------------------
inline bool operator<(long l, const wxLongLong& ll)
{
  return ll > l;
}
inline bool operator>(long l, const wxLongLong& ll)
...
inline bool operator<(unsigned long l, const wxULongLong& ull)
{
  return ull > l;
}
inline bool operator>(unsigned long l, const wxULongLong& ull)
...
#      ifdef __clang__
  ...
  // warns about this
  template <>
  struct numeric_limits<wxLongLong> : public numeric_limits<wxLongLong_t>
  {
  };
  template <>
  struct numeric_limits<wxULongLong> : public numeric_limits<wxULongLong_t>
  {
  };
#      else 
  template <>
  class numeric_limits<wxLongLong> : public numeric_limits<wxLongLong_t>
  {
  };
  template <>
  class numeric_limits<wxULongLong> : public numeric_limits<wxULongLong_t>
  {
  };
#      endif
}
...
{
  wxArgNormalizer(wxLongLong value, const wxFormatString* fmt, unsigned index)
    : m_value(value)
  {
    wxASSERT_ARG_TYPE(fmt, index, wxFormatString::Arg_LongLongInt);
  }
  wxLongLong_t get() const
  {
