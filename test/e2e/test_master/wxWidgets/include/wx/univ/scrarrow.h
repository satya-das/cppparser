...
public:
  ...
  void DrawArrow(Arrow arrow, wxDC& dc, const wxRect& rect, bool scrollbarLike = false) const;
...
public:
  ...
  virtual void SetArrowFlag(wxScrollArrows::Arrow arrow, int flag, bool set = true) = 0;
