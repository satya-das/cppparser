...
public:
  ...
  virtual wxInputHandler* GetInputHandler(const wxString& handlerType, wxInputConsumer* consumer) = 0;
...
public:
  ...
  virtual wxInputHandler* GetInputHandler(const wxString& control, wxInputConsumer* consumer);
