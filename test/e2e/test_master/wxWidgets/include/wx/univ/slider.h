...
// wxSlider
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_CORE wxSlider : public wxSliderBase, public wxControlWithThumb
{
public:
    // ctors and such
  wxSlider();
  ...
  void SetShaftPartState(wxScrollThumb::Shaft shaftPart, int flag, bool set = true) override;
...
protected:
  ...
  void CalcThumbRect(const wxRect* rectShaft, wxRect* rectThumbOut, wxRect* rectLabelOut, int value = INVALID_THUMB_VALUE) const;
...
private:
  ...
  wxRect m_rectLabel, m_rectTicks, m_rectSlider;
