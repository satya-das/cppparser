...
// wxScrollBar
// ----------------------------------------------------------------------------
class WXDLLIMPEXP_CORE wxScrollBar : public wxScrollBarBase, public wxControlWithArrows
{
public:
...
protected:
  ...
  static void GetScrollBarThumbSize(wxCoord length, int thumbPos, int thumbSize, int range, wxCoord* thumbStart, wxCoord* thumbEnd);
private:
  ...
  int m_thumbSize, m_thumbPos, m_thumbPosOld;
  ...
  friend class WXDLLIMPEXP_FWD_CORE wxControlRenderer;
  friend class wxStdScrollBarInputHandler;
...
public:
  ...
  wxStdScrollBarInputHandler(wxRenderer* renderer, wxInputHandler* inphand);
  ...
  virtual bool OnScrollTimer(wxScrollBar* scrollbar, const wxControlAction& action);
protected:
  ...
  wxCoord GetMouseCoord(const wxScrollBar* scrollbar, const wxMouseEvent& event) const;
