...
public:
  ...
  virtual wxSocketImpl* CreateSocket(wxSocketBase& wxsocket) = 0;
    ...
    // this parameter
  virtual void Install_Callback(wxSocketImpl* socket, wxSocketNotify event = wxSOCKET_LOST) = 0;
...
public:
  ...
  wxSocketEventFlags Select(wxSocketEventFlags flags, wxTimeVal_t* timeout = NULL);
...
//protected:
  ...
  wxSockAddressImpl m_local, m_peer;
