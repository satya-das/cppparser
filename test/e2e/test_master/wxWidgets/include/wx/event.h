...
WXDLLIMPEXP_BASE extern wxEventType wxNewEventType();
...
public:
  ...
  wxEventTypeTag(wxEventType type)
    : m_type(type)
  {
  }
...
public:
  ...
  bool IsMatching(const wxEventFunctor& functor) const override
  {
    ...
    {
      const wxObjectEventFunctor& other = static_cast<const wxObjectEventFunctor&>(functor);
      return (m_method == other.m_method || !other.m_method) && (m_handler == other.m_handler || !other.m_handler);
    }
    else 
    {
      return false;
...
inline wxObjectEventFunctor* wxNewEventFunctor(const wxEventType&, wxObjectEventFunction method, wxEvtHandler* handler)
{
  return new wxObjectEventFunctor(method, handler);
}
// This version is used by wxDECLARE_EVENT_TABLE_ENTRY()
inline wxObjectEventFunctor* wxNewEventTableFunctor(const wxEventType&, wxObjectEventFunction method)
{
  return new wxObjectEventFunctor(method, NULL);
}
inline wxObjectEventFunctor wxMakeEventFunctor(const wxEventType&, wxObjectEventFunction method, wxEvtHandler* handler)
{
...
// specialization for handlers deriving from wxEvtHandler
  ...
  struct HandlerImpl<T, A, true>
  {
    ...
    static wxEventFunction ConvertToEvtMethod(void (*f) (A&))
    {
      return wxEventFunctionCast(static_cast<void (*) (A&)>(f));
    }
  };
// specialization for handlers not deriving from wxEvtHandler
  ...
  struct HandlerImpl<T, A, false>
  {
    ...
    static wxEventFunction ConvertToEvtMethod(void (*) (A&))
    {
      return NULL;
    }
  };
...
public:
  ...
  wxEventFunctorMethod(void (*method) (EventArg&), EventHandler* handler)
    : m_handler(handler)
    , m_method(method)
  {
  ...
  bool IsMatching(const wxEventFunctor& functor) const override
  {
    ...
    typedef wxEventFunctorMethod<EventTag, Class, EventArg, EventHandler> ThisFunctor;
        // the cast is valid because wxTypeId()s matched above
    const ThisFunctor& other = static_cast<const ThisFunctor&>(functor);
    return (m_method == other.m_method || other.m_method == NULL) && (m_handler == other.m_handler || other.m_handler == NULL);
  }
  wxEvtHandler* GetEvtHandler() const override
  {
...
public:
  ...
  void operator()(wxEvtHandler*, wxEvent& event) override
  {
...
// many, but not all, standard event types
    ...
    // some generic events
WXDLLIMPEXP_BASE extern const wxEventType wxEVT_NULL;
WXDLLIMPEXP_BASE extern const wxEventType wxEVT_FIRST;
WXDLLIMPEXP_BASE extern const wxEventType wxEVT_USER_FIRST;
...
public:
  ...
  wxEvtHandler* GetPropagatedFrom() const
  {
    return m_propagatedFrom;
  }
...
// Thread event
class WXDLLIMPEXP_BASE wxThreadEvent : public wxEvent, public wxEventAnyPayloadMixin
{
public:
...
public:
  ...
  wxAsyncMethodCallEvent0(ObjectType* object, MethodType method)
...
public:
  typedef T ObjectType;
  typedef void (*MethodType) (T1 x1, T2 x2);
  typedef typename wxRemoveRef<T1>::type ParamType1;
  typedef typename wxRemoveRef<T2>::type ParamType2;
  wxAsyncMethodCallEvent2(ObjectType* object, MethodType method, const ParamType1& x1, const ParamType2& x2)
    : wxAsyncMethodCallEvent(object)
    , m_object(object)
    , m_method(method)
    , m_param1(x1)
...
public:
  ...
  {
    return m_commandInt != 0;
  }
    // true if the listbox event was a selection.
  bool IsSelection() const
  {
    return (m_extraLong != 0);
  }
  wxEvent* Clone() const override
  {
    return new wxCommandEvent(*this);
  }
  wxEventCategory GetEventCategory() const override
  {
...
{
public:
  wxScrollEvent(wxEventType commandType = wxEVT_NULL, int winid = 0, int pos = 0, int orient = 0);
  int GetOrientation() const
  {
    return (int) m_extraLong;
  }
...
{
public:
  wxScrollWinEvent(wxEventType commandType = wxEVT_NULL, int pos = 0, int orient = 0);
  ...
  wxEvent* Clone() const override
  {
    return new wxScrollWinEvent(*this);
  }
protected:
  int m_commandInt;
  long m_extraLong;
...
class WXDLLIMPEXP_CORE wxMouseEvent : public wxEvent, public wxMouseState
{
public:
  ...
  bool LeftDown() const
  {
    return (m_eventType == wxEVT_LEFT_DOWN);
  }
  bool MiddleDown() const
  {
    return (m_eventType == wxEVT_MIDDLE_DOWN);
  }
  bool RightDown() const
  {
    return (m_eventType == wxEVT_RIGHT_DOWN);
  }
  bool Aux1Down() const
  {
    return (m_eventType == wxEVT_AUX1_DOWN);
  }
  bool Aux2Down() const
  {
    return (m_eventType == wxEVT_AUX2_DOWN);
  }
  bool LeftUp() const
  {
    return (m_eventType == wxEVT_LEFT_UP);
  }
  bool MiddleUp() const
  {
    return (m_eventType == wxEVT_MIDDLE_UP);
  }
  bool RightUp() const
  {
    return (m_eventType == wxEVT_RIGHT_UP);
  }
  bool Aux1Up() const
  {
    return (m_eventType == wxEVT_AUX1_UP);
  }
  bool Aux2Up() const
  {
    return (m_eventType == wxEVT_AUX2_UP);
  }
  bool LeftDClick() const
  {
    return (m_eventType == wxEVT_LEFT_DCLICK);
  }
  bool MiddleDClick() const
  {
    return (m_eventType == wxEVT_MIDDLE_DCLICK);
  }
  bool RightDClick() const
  {
    return (m_eventType == wxEVT_RIGHT_DCLICK);
  }
  bool Aux1DClick() const
  {
    return (m_eventType == wxEVT_AUX1_DCLICK);
  }
  bool Aux2DClick() const
  {
    return (m_eventType == wxEVT_AUX2_DCLICK);
  }
  bool Magnify() const
  {
    return (m_eventType == wxEVT_MAGNIFY);
  }
  ...
  bool Entering() const
  {
    return (m_eventType == wxEVT_ENTER_WINDOW);
  }
    // True if the mouse is just leaving the window
  bool Leaving() const
  {
    return (m_eventType == wxEVT_LEAVE_WINDOW);
  }
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxSetCursorEvent(*this);
  }
private:
  wxCoord m_x, m_y;
  wxCursor m_cursor;
...
public:
  ...
  wxGestureEvent(const wxGestureEvent& event)
    : wxEvent(event)
    , m_pos(event.m_pos)
  {
  ...
  wxEvent* Clone() const override
  {
    return new wxGestureEvent(*this);
  }
protected:
  wxPoint m_pos;
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxPanGestureEvent(*this);
  }
private:
  wxPoint m_delta;
...
public:
  ...
  wxZoomGestureEvent(const wxZoomGestureEvent& event)
    : wxGestureEvent(event)
  {
  ...
  wxEvent* Clone() const override
  {
    return new wxZoomGestureEvent(*this);
  }
private:
  double m_zoomFactor;
...
public:
  ...
  wxRotateGestureEvent(const wxRotateGestureEvent& event)
    : wxGestureEvent(event)
  {
  ...
  wxEvent* Clone() const override
  {
    return new wxRotateGestureEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxTwoFingerTapEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxLongPressEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxPressAndTapEvent(*this);
  }
private:
...
class WXDLLIMPEXP_CORE wxKeyEvent : public wxEvent, public wxKeyboardState
{
public:
...
public:
  ...
  wxMoveEvent(const wxRect& rect, int id = 0)
    : m_pos(rect.GetPosition())
    , m_rect(rect)
  {
    m_eventType = wxEVT_MOVING;
    m_id = id;
  }
  wxPoint GetPosition() const
  {
...
public:
  wxEvent* Clone() const override
  {
    return new wxNcPaintEvent(*this);
  }
private:
...
public:
  ...
  wxWindow* GetWindow() const
  {
    return (wxWindow*) GetEventObject();
  }
  wxEvent* Clone() const override
  {
    return new wxChildFocusEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxActivateEvent(*this);
  }
private:
  bool m_active;
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxInitDialogEvent(*this);
  }
private:
...
public:
  ...
  void Veto(bool veto = true)
  {
    ...
    wxCHECK_RET(m_canVeto, wxT("call to Veto() ignored (can't veto this event)"));
    m_veto = veto;
  }
  ...
  wxEvent* Clone() const override
  {
    return new wxCloseEvent(*this);
  }
protected:
  bool m_loggingOff, m_veto, m_canVeto;
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxIconizeEvent(*this);
  }
protected:
  bool m_iconized;
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxMaximizeEvent(*this);
  }
private:
...
protected:
  ...
  int m_joyStick;
public:
  wxJoystickEvent(wxEventType type = wxEVT_NULL, int state = 0, int joystick = wxJOYSTICK1, int change = 0)
    : wxEvent(0, type)
    , m_pos()
    , m_zPosition(0)
  ...
  {
    return m_buttonChange;
  }
  int GetButtonOrdinal() const
  {
    return wxCTZ(m_buttonChange);
  }
  ...
  bool IsButton() const
  {
    return ((GetEventType() == wxEVT_JOY_BUTTON_DOWN) || (GetEventType() == wxEVT_JOY_BUTTON_UP));
  }
    // Was it a move event?
  bool IsMove() const
  {
  ...
  bool IsZMove() const
  {
    return (GetEventType() == wxEVT_JOY_ZMOVE);
  }
    // Was it a down event from button 1, 2, 3, 4 or any?
  bool ButtonDown(int but = wxJOY_BUTTON_ANY) const
  {
    return ((GetEventType() == wxEVT_JOY_BUTTON_DOWN) && ((but == wxJOY_BUTTON_ANY) || (but == m_buttonChange)));
  }
    // Was it a up event from button 1, 2, 3 or any?
  bool ButtonUp(int but = wxJOY_BUTTON_ANY) const
  {
    return ((GetEventType() == wxEVT_JOY_BUTTON_UP) && ((but == wxJOY_BUTTON_ANY) || (but == m_buttonChange)));
  }
    // Was the given button 1,2,3,4 or any in Down state?
  bool ButtonIsDown(int but = wxJOY_BUTTON_ANY) const
  {
    return (((but == wxJOY_BUTTON_ANY) && (m_buttonState != 0)) || ((m_buttonState & but) == but));
  }
  wxEvent* Clone() const override
  {
    return new wxJoystickEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxDropFilesEvent(*this);
  }
private:
...
public:
  ...
  {
    m_checked = m_enabled = m_shown = m_setEnabled = m_setShown = m_setText = m_setChecked = false;
    m_isCheckable = true;
  }
  ...
  {
    sm_updateInterval = updateInterval;
  }
    // Returns the current interval between updates in milliseconds
  static long GetUpdateInterval()
  {
    return sm_updateInterval;
  }
  ...
  {
    return sm_updateMode;
  }
  wxEvent* Clone() const override
  {
    return new wxUpdateUIEvent(*this);
  }
protected:
  bool m_checked;
  bool m_enabled;
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxSysColourChangedEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxMouseCaptureChangedEvent(*this);
  }
  wxWindow* GetCapturedWindow() const
  {
    return m_gainedCapture;
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxMouseCaptureLostEvent(*this);
  }
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxDisplayChangedEvent(*this);
  }
};
/*
 wxEVT_DPI_CHANGED
...
{
public:
  explicit wxDPIChangedEvent(const wxSize& oldDPI = wxDefaultSize, const wxSize& newDPI = wxDefaultSize)
  ...
  wxEvent* Clone() const override
  {
    return new wxDPIChangedEvent(*this);
  }
private:
  wxSize m_oldDPI;
  wxSize m_newDPI;
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxPaletteChangedEvent(*this);
  }
protected:
...
public:
  ...
  {
    m_paletteRealized = realized;
  }
  bool GetPaletteRealized() const
  {
    return m_paletteRealized;
  }
  wxEvent* Clone() const override
  {
    return new wxQueryNewPaletteEvent(*this);
  }
protected:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxNavigationKeyEvent(*this);
  }
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxWindowCreateEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxWindowDestroyEvent(*this);
  }
private:
...
public:
  ...
  wxHelpEvent(wxEventType type = wxEVT_NULL, wxWindowID winid = 0, const wxPoint& pt = wxDefaultPosition, Origin origin = Origin_Unknown)
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxClipboardTextEvent(*this);
  }
private:
...
public:
  ...
  wxEvent* Clone() const override
  {
    return new wxContextMenuEvent(*this);
  }
protected:
  wxPoint m_pos;
private:
...
{
  wxDynamicEventTableEntry(int evType, int winid, int idLast, wxEventFunctor* fn, wxObject* data)
    : wxEventTableEntryBase(winid, idLast, fn, data)
    , m_eventType(evType)
  {
  }
...
#  endif
  ...
  {
    DoBind(winid, lastId, eventType, wxNewEventFunctor(eventType, func, eventSink), userData);
  }
  ...
  {
    return DoUnbind(winid, lastId, eventType, wxMakeEventFunctor(eventType, func, eventSink), userData);
  }
  ...
  {
    GetEventHashTable().Clear();
  }
  void OnSinkDestroyed(wxEvtHandler* sink);
private:
  void DoBind(int winid, int lastId, wxEventType eventType, wxEventFunctor* func, wxObject* userData = NULL);
  bool DoUnbind(int winid, int lastId, wxEventType eventType, const wxEventFunctor& func, wxObject* userData = NULL);
...
public:
  ...
  wxEventConnectionRef* ToEventConnection() override
  {
    return this;
  }
  void IncRef()
...
typedef void (*wxEventFunction) (wxEvent&);
typedef void (*wxIdleEventFunction) (wxIdleEvent&);
typedef void (*wxThreadEventFunction) (wxThreadEvent&);
...
typedef void (*wxCommandEventFunction) (wxCommandEvent&);
typedef void (*wxScrollEventFunction) (wxScrollEvent&);
typedef void (*wxScrollWinEventFunction) (wxScrollWinEvent&);
typedef void (*wxSizeEventFunction) (wxSizeEvent&);
typedef void (*wxMoveEventFunction) (wxMoveEvent&);
typedef void (*wxPaintEventFunction) (wxPaintEvent&);
typedef void (*wxNcPaintEventFunction) (wxNcPaintEvent&);
typedef void (*wxEraseEventFunction) (wxEraseEvent&);
typedef void (*wxMouseEventFunction) (wxMouseEvent&);
typedef void (*wxCharEventFunction) (wxKeyEvent&);
typedef void (*wxFocusEventFunction) (wxFocusEvent&);
typedef void (*wxChildFocusEventFunction) (wxChildFocusEvent&);
typedef void (*wxActivateEventFunction) (wxActivateEvent&);
typedef void (*wxMenuEventFunction) (wxMenuEvent&);
typedef void (*wxJoystickEventFunction) (wxJoystickEvent&);
typedef void (*wxDropFilesEventFunction) (wxDropFilesEvent&);
typedef void (*wxInitDialogEventFunction) (wxInitDialogEvent&);
typedef void (*wxSysColourChangedEventFunction) (wxSysColourChangedEvent&);
typedef void (*wxDisplayChangedEventFunction) (wxDisplayChangedEvent&);
typedef void (*wxDPIChangedEventFunction) (wxDPIChangedEvent&);
typedef void (*wxUpdateUIEventFunction) (wxUpdateUIEvent&);
typedef void (*wxCloseEventFunction) (wxCloseEvent&);
typedef void (*wxShowEventFunction) (wxShowEvent&);
typedef void (*wxIconizeEventFunction) (wxIconizeEvent&);
typedef void (*wxMaximizeEventFunction) (wxMaximizeEvent&);
typedef void (*wxNavigationKeyEventFunction) (wxNavigationKeyEvent&);
typedef void (*wxPaletteChangedEventFunction) (wxPaletteChangedEvent&);
typedef void (*wxQueryNewPaletteEventFunction) (wxQueryNewPaletteEvent&);
typedef void (*wxWindowCreateEventFunction) (wxWindowCreateEvent&);
typedef void (*wxWindowDestroyEventFunction) (wxWindowDestroyEvent&);
typedef void (*wxSetCursorEventFunction) (wxSetCursorEvent&);
typedef void (*wxNotifyEventFunction) (wxNotifyEvent&);
typedef void (*wxHelpEventFunction) (wxHelpEvent&);
typedef void (*wxContextMenuEventFunction) (wxContextMenuEvent&);
typedef void (*wxMouseCaptureChangedEventFunction) (wxMouseCaptureChangedEvent&);
typedef void (*wxMouseCaptureLostEventFunction) (wxMouseCaptureLostEvent&);
typedef void (*wxClipboardTextEventFunction) (wxClipboardTextEvent&);
typedef void (*wxPanGestureEventFunction) (wxPanGestureEvent&);
typedef void (*wxZoomGestureEventFunction) (wxZoomGestureEvent&);
typedef void (*wxRotateGestureEventFunction) (wxRotateGestureEvent&);
typedef void (*wxTwoFingerTapEventFunction) (wxTwoFingerTapEvent&);
typedef void (*wxLongPressEventFunction) (wxLongPressEvent&);
typedef void (*wxPressAndTapEventFunction) (wxPressAndTapEvent&);
