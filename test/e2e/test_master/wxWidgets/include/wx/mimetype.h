...
{
private:
  void DoVarArgInit(const wxString& mimeType, const wxString& openCmd, const wxString& printCmd, const wxString& desc, va_list argptr);
  void VarArgInit(const wxString* mimeType, const wxString* openCmd, const wxString* printCmd, const wxString* desc, ...);
public:
...
{
  friend class WXDLLIMPEXP_FWD_BASE wxMimeTypesManagerImpl;
public:
 ...
 return wxEmptyString;
  ...
  bool GetIcon(wxIconLocation* iconloc, const MessageParameters& params) const;
  ...
  bool GetOpenCommand(wxString* openCmd, const MessageParameters& params) const;
  ...
  bool GetPrintCommand(wxString* printCmd, const MessageParameters& params) const;
...
public:
  ...
  wxMimeTypesManager();
    ...
    // directory
  void Initialize(int mailcapStyle = wxMAILCAP_ALL, const wxString& extraDir = wxEmptyString);
...
WXDLLIMPEXP_BASE extern wxMimeTypesManager* wxTheMimeTypesManager;
#  endif
#endif
  //_WX_MIMETYPE_H_
