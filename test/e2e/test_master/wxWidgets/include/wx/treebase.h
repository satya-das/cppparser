...
#      define wxTR_DEFAULT_STYLE(wxTR_HAS_BUTTONS | wxTR_NO_LINES | wxTR_FULL_ROW_HIGHLIGHT)
#    else 
...
WXDLLIMPEXP_CORE extern const char wxTreeCtrlNameStr[];
// ----------------------------------------------------------------------------
