 ...
 */
  ...
  {
  public:
    PdfFontMetricsBase14(const char* mfont_name, const PODOFO_CharData* mwidths_table, bool mis_font_specific, pdf_int16 mascent, pdf_int16 mdescent, pdf_uint16 mx_height, pdf_uint16 mcap_height, pdf_int16 mstrikeout_pos, pdf_int16 munderline_pos, const PdfRect& mbbox);
    ~PdfFontMetricsBase14();
    friend const PdfFontMetricsBase14* PODOFO_Base14FontDef_FindBuiltinData(const char* font_name);
...
//	const PODOFO_Base14FontDefDataRec& base14font_data;
  ...
  const PdfFontMetricsBase14* PODOFO_Base14FontDef_FindBuiltinData(const char* font_name);
// -----------------------------------------------------
// 
// -----------------------------------------------------
