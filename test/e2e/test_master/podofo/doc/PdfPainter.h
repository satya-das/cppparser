 ...
 */
  ...
  public:
     ...
     *  \param bSkipSpaces whether the trailing whitespaces should be skipped, so that next line doesn't start with whitespace
     */
    inline void DrawMultiLineText(const PdfRect& rRect, const PdfString& rsText, EPdfAlignment eAlignment = ePdfAlignment_Left, EPdfVerticalAlignment eVertical = ePdfVerticalAlignment_Top, bool bClip = true, bool bSkipSpaces = true);
...
#  endif
    ...
    double lpx, lpy, lpx2, lpy2, lpx3, lpy3, lcx, lcy, lrx, lry;
  };
// -----------------------------------------------------
// 
// -----------------------------------------------------
