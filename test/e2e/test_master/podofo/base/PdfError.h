 ...
 */
  ...
  public:
     ...
     */
    explicit PdfError(const EPdfError& eCode, const char* pszFile, int line, std::string sInformation);
    /** Copy constructor
     ...
     */
    inline void SetError(const EPdfError& eCode, const char* pszFile, int line, std::string sInformation);
    /** Set the error code of this object.
     *  \param eCode the error code of this object
     *  \param pszFile the filename of the source file causing
     *                 the error or NULL. Typically you will use
