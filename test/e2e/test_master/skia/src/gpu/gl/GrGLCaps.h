...
public:
  ...
  void getTexSubImageExternalFormatAndType(GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType, GrGLenum* externalFormat, GrGLenum* externalType) const;
     ...
     */
  void getTexSubImageZeroFormatTypeAndBpp(GrGLFormat format, GrGLenum* externalFormat, GrGLenum* externalType, size_t* bpp) const;
...
private:
  ...
  void getExternalFormat(GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType, ExternalFormatUsage usage, GrGLenum* externalFormat, GrGLenum* externalType) const;
  ...
  void applyDriverCorrectnessWorkarounds(const GrGLContextInfo&, const GrContextOptions&, GrShaderCaps*, FormatWorkarounds*);
  void onApplyOptionsOverrides(const GrContextOptions& options) override;
  bool onIsWindowRectanglesSupportedForRT(const GrBackendRenderTarget&) const override;
  void initFSAASupport(const GrContextOptions& contextOptions, const GrGLContextInfo&, const GrGLInterface*);
  ...
  bool fImagingSupport;
  bool fVertexArrayObjectSupport;
  bool fDebugSupport;
  bool fES2CompatibilitySupport;
  bool fDrawInstancedSupport;
  bool fDrawIndirectSupport;
  bool fDrawRangeElementsSupport;
  bool fMultiDrawIndirectSupport;
  bool fBaseInstanceSupport;
  bool fUseNonVBOVertexAndIndexDynamicData;
  bool fIsCoreProfile;
  bool fBindFragDataLocationSupport;
  bool fRGBA8888PixelsOpsAreSlow;
  bool fPartialFBOReadIsSlow;
  bool fBindUniformLocationSupport;
  bool fRectangleTextureSupport;
  bool fMipMapLevelAndLodControlSupport;
  bool fRGBAToBGRAReadbackConversionsAreSlow;
  bool fUseBufferDataNullHint;
  bool fClearTextureSupport;
  bool fProgramBinarySupport;
  bool fProgramParameterSupport;
  bool fSamplerObjectSupport;
  bool fFBFetchRequiresEnablePerSample;
  bool fSRGBWriteControl;
    // Driver workarounds
  bool fDoManualMipmapping;
  bool fClearToBoundaryValuesIsBroken;
  bool fDrawArraysBaseVertexIsBroken;
  bool fDisallowTexSubImageForUnormConfigTexturesEverBoundToFBO;
  bool fUseDrawInsteadOfAllRenderTargetWrites;
  bool fRequiresCullFaceEnableDisableWhenDrawingLinesAfterNonLines;
  bool fDetachStencilFromMSAABuffersBeforeReadPixels;
  bool fDontSetBaseOrMaxLevelForExternalTextures;
  bool fNeverDisableColorWrites;
