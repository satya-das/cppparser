...
public:
  ...
  void setProjectionMatrix(const SkMatrix& matrix, const SkISize& renderTargetSize, GrSurfaceOrigin renderTargetOrigin);
...
protected:
  ...
  void onDrawPath(GrRenderTarget*, int numSamples, GrSurfaceOrigin, const GrPrimitiveProcessor&, const GrPipeline&, const GrPipeline::FixedDynamicState&, const GrStencilSettings&, const GrPath*) override;
private:
    /**
