...
public:
  ...
  GrBackendTexture onCreateBackendTexture(int w, int h, const GrBackendFormat&, GrMipMapped, GrRenderable, const SkPixmap srcData[], int numMipLevels, const SkColor4f* color, GrProtected isProtected) override;
...
#  endif
  ...
  sk_sp<GrDawnProgram> getOrCreateRenderPipeline(GrRenderTarget*, GrSurfaceOrigin origin, const GrPipeline&, const GrPrimitiveProcessor&, const GrTextureProxy* const * primProcProxies, bool hasPoints, GrPrimitiveType primitiveType);
...
private:
  ...
  void onResolveRenderTarget(GrRenderTarget*, const SkIRect&, GrSurfaceOrigin, ForExternalIO) override
  {
  }
