...
public:
  ...
  enum FilterConstraint {
     ...
     **/
  virtual std::unique_ptr<GrFragmentProcessor> createFragmentProcessor(const SkMatrix& textureMatrix, const SkRect& constraintRect, FilterConstraint filterConstraint, bool coordsLimitedToConstraintRect, const GrSamplerState::Filter* filterOrNullForBicubic) = 0;
    /**
  ...
  sk_sp<GrTextureProxy> refTextureProxyForParams(const GrSamplerState::Filter* filterOrNullForBicubic, SkScalar scaleAdjust[2]);
    /**
...
protected:
  ...
  static sk_sp<GrTextureProxy> CopyOnGpu(GrRecordingContext*, sk_sp<GrTextureProxy> inputProxy, GrColorType, const CopyParams& copyParams, bool dstWillRequireMipMaps);
