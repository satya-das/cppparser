...
namespace GrDefaultGeoProcFactory
{
  ...
  sk_sp<GrGeometryProcessor> Make(const GrShaderCaps*, const Color&, const Coverage&, const LocalCoords&, const SkMatrix& viewMatrix);
    /*
     ...
     */
  sk_sp<GrGeometryProcessor> MakeForDeviceSpace(const GrShaderCaps*, const Color&, const Coverage&, const LocalCoords&, const SkMatrix& viewMatrix);
}
#endif
