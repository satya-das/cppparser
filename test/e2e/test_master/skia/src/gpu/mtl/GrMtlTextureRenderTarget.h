...
{
public:
  static sk_sp<GrMtlTextureRenderTarget> MakeNewTextureRenderTarget(GrMtlGpu*, SkBudgeted, const GrSurfaceDesc&, int sampleCnt, MTLTextureDescriptor*, GrMipMapsStatus);
...
private:
  ...
  GrMtlTextureRenderTarget(GrMtlGpu* gpu, const GrSurfaceDesc& desc, int sampleCnt, id<MTLTexture> colorTexture, id<MTLTexture> resolveTexture, GrMipMapsStatus, GrWrapCacheable cacheable);
  GrMtlTextureRenderTarget(GrMtlGpu* gpu, const GrSurfaceDesc& desc, id<MTLTexture> colorTexture, GrMipMapsStatus, GrWrapCacheable cacheable);
