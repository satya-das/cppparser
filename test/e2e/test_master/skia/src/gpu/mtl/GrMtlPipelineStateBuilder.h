...
public:
  ...
  private:
     ...
     */
  static GrMtlPipelineState* CreatePipelineState(GrMtlGpu*, GrRenderTarget*, int numSamples, GrSurfaceOrigin, const GrPrimitiveProcessor&, const GrTextureProxy* const primProcProxies[], const GrPipeline&, Desc*);
private:
  GrMtlPipelineStateBuilder(GrMtlGpu*, GrRenderTarget*, int numSamples, GrSurfaceOrigin, const GrPipeline&, const GrPrimitiveProcessor&, const GrTextureProxy* const primProcProxies[], GrProgramDesc*);
  GrMtlPipelineState* finalize(GrRenderTarget* renderTarget, const GrPrimitiveProcessor& primProc, const GrPipeline& pipeline, Desc*);
