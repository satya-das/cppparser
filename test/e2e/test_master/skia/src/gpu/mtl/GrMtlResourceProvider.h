...
public:
  ...
  GrMtlPipelineState* findOrCreateCompatiblePipelineState(GrRenderTarget*, int numSamples, GrSurfaceOrigin, const GrPipeline&, const GrPrimitiveProcessor&, const GrTextureProxy* const primProcProxies[], GrPrimitiveType);
...
private:
  ...
  public:
    ...
    ~PipelineStateCache();
    void release();
    GrMtlPipelineState* refPipelineState(GrRenderTarget*, int numSamples, GrSurfaceOrigin, const GrPrimitiveProcessor&, const GrTextureProxy* const primProcProxies[], const GrPipeline&, GrPrimitiveType);
  private:
    struct Entry;
    struct DescHash
    {
