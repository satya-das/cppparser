...
protected:
  ...
  GrRenderTargetProxy(LazyInstantiateCallback&&, const GrBackendFormat&, const GrSurfaceDesc&, int sampleCount, GrSurfaceOrigin, const GrSwizzle& textureSwizzle, const GrSwizzle& outputSwizzle, SkBackingFit, SkBudgeted, GrProtected, GrInternalSurfaceFlags, UseAllocator, WrapsVkSecondaryCB);
    // Wrapped version
  GrRenderTargetProxy(sk_sp<GrSurface>, GrSurfaceOrigin, const GrSwizzle& textureSwizzle, const GrSwizzle& outputSwizzle, UseAllocator, WrapsVkSecondaryCB = WrapsVkSecondaryCB::kNo);
