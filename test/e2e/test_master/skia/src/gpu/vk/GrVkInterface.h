...
public:
  GrVkInterface(GrVkGetProc getProc, VkInstance instance, VkDevice device, uint32_t instanceVersion, uint32_t physicalDeviceVersion, const GrVkExtensions*);
  ...
  bool validate(uint32_t instanceVersion, uint32_t physicalDeviceVersion, const GrVkExtensions*) const;
    /**
