...
private:
  ...
  const GrVkBuffer::Resource* createResource(GrVkGpu* gpu, const GrVkBuffer::Desc& descriptor) override;
  GrVkUniformBuffer(GrVkGpu* gpu, const GrVkBuffer::Desc& desc, const GrVkUniformBuffer::Resource* resource)
