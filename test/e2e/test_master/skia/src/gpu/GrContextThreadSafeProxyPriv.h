...
private:
  ...
  GrContextThreadSafeProxyPriv& operator=(const GrContextThreadSafeProxyPriv&);
    // No taking addresses of this type.
  const GrContextThreadSafeProxyPriv* operator&() const;
  GrContextThreadSafeProxyPriv* operator&();
