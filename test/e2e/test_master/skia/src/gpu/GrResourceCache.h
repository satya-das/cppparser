...
static bool SkShouldPostMessageToBus(const GrGpuResourceFreedMessage& msg, uint32_t msgBusUniqueID)
{
...
#  endif
 ...
 return key.hash();
  ...
  public:
    ...
    ResourceAwaitingUnref& operator=(const ResourceAwaitingUnref&);
