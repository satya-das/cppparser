...
public:
  ...
  GrPixelConfig getConfigFromBackendFormat(const GrBackendFormat& format, GrColorType grCT) const
  {
     ...
     */
  virtual GrColorType getYUVAColorTypeFromBackendFormat(const GrBackendFormat&, bool isAlphaChannel) const = 0;
...
protected:
  ...
  bool fMultisampleDisableSupport;
  bool fInstanceAttribSupport;
  bool fMixedSamplesSupport;
  ...
  bool fAllowCoverageCounting;
  bool fTransferBufferSupport;
  bool fWritePixelsRowBytesSupport;
  bool fReadPixelsRowBytesSupport;
    // Driver workaround
  bool fDriverBlacklistCCPR;
  bool fDriverBlacklistMSAACCPR;
  ...
  bool fPreferTrianglesOverSampleMask;
  bool fFenceSyncSupport;
...
private:
  ...
  virtual bool onCanCopySurface(const GrSurfaceProxy* dst, const GrSurfaceProxy* src, const SkIRect& srcRect, const SkIPoint& dstPoint) const = 0;
