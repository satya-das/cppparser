...
private:
  ...
  public:
    ...
    OpChain& operator=(const OpChain&);
  ...
  private:
    ...
    void validate() const;
    bool tryConcat(List*, GrProcessorSet::Analysis, const DstProxy&, const GrAppliedClip*, const SkRect& bounds, const GrCaps&, GrOpMemoryPool*, GrAuditTrail*);
  ...
  void recordOp(std::unique_ptr<GrOp>, GrProcessorSet::Analysis, GrAppliedClip*, const DstProxy*, const GrCaps& caps);
