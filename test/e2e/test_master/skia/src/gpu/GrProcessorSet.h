...
public:
  ...
  GrProcessorSet& operator=(const GrProcessorSet&);
  ~GrProcessorSet();
 ...
 *reinterpret_cast<uint32_t*>(this) = 0;     }
  ...
  private:
    ...
    PackedBool fUsesLocalCoords;
    PackedBool fCompatibleWithCoverageAsAlpha;
    PackedBool fRequiresDstTexture;
    PackedBool fRequiresNonOverlappingDraws;
    PackedBool fHasColorFragmentProcessor;
    PackedBool fIsInitialized;
    PackedInputColorType fInputColorType;
