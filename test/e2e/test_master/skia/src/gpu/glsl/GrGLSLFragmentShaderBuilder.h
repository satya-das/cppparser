 ...
 */
class GrGLSLFPFragmentBuilder : public GrGLSLFragmentBuilder
{
public:
  ...
  virtual SkString writeProcessorFunction(GrGLSLFragmentProcessor* fp, GrGLSLFragmentProcessor::EmitArgs& args);
