...
public:
  ...
  inline void invokeChild(int childIndex, SkString* outputColor, EmitArgs& parentArgs, SkSL::String skslCoords = "")
  {
     ...
     *  color.
     */
  void invokeChild(int childIndex, const char* inputColor, SkString* outputColor, EmitArgs& parentArgs, SkSL::String skslCoords = "");
...
private:
  void writeChildCall(GrGLSLFPFragmentBuilder* fragBuilder, int childIndex, TransformedCoordVars coordVars, const char* inputColor, const char* outputColor, EmitArgs& args, SkSL::String skslCoords);
