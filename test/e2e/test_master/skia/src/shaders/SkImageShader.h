...
{
public:
  static sk_sp<SkShader> Make(sk_sp<SkImage>, SkTileMode tmx, SkTileMode tmy, const SkMatrix* localMatrix, bool clampAsIfUnpremul = false);
...
private:
  ...
  SkImageShader(sk_sp<SkImage>, SkTileMode tmx, SkTileMode tmy, const SkMatrix* localMatrix, bool clampAsIfUnpremul);
