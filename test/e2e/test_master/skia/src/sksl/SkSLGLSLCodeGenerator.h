 ...
 */
  ...
  protected:
    ...
    void writeSwizzleConstructor(const Swizzle& swizzle, const String& constants, const String& mask, SwizzleOrder order);
    void writeSwizzleConstructor(const Swizzle& swizzle, const String& constants, const String& mask, const String& reswizzle);
