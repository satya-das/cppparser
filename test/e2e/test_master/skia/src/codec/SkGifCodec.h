...
public:
  ...
  void haveDecodedRow(int frameIndex, const unsigned char* rowBegin, int rowNumber, int repeatCount, bool writeTransparentPixels);
protected:
    /*
  ...
  Result onStartIncrementalDecode(const SkImageInfo&, void*, size_t, const SkCodec::Options&) override;
