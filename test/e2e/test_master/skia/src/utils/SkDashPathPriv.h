...
namespace SkDashPath
{
  ...
  enum class StrokeRecApplication {
     ...
     */
  bool InternalFilter(SkPath* dst, const SkPath& src, SkStrokeRec* rec, const SkRect* cullRect, const SkScalar aIntervals[], int32_t count, SkScalar initialDashLength, int32_t initialDashIndex, SkScalar intervalLength, StrokeRecApplication = StrokeRecApplication::kAllow);
