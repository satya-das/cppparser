...
public:
  ...
  SK_STDMETHODIMP Write(const void* pv, ULONG cb, ULONG* pcbWritten) override;
    // IStream methods
  ...
  SK_STDMETHODIMP Seek(LARGE_INTEGER liDistanceToMove, DWORD dwOrigin, ULARGE_INTEGER* lpNewFilePointer) override;
