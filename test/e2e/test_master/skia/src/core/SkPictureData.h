...
public:
  ...
  static SkPictureData* CreateFromStream(SkStream*, const SkPictInfo&, const SkDeserialProcs&, SkTypefacePlayback*);
...
private:
    ...
    // Does not affect ownership of SkStream.
  bool parseStreamTag(SkStream*, uint32_t tag, uint32_t size, const SkDeserialProcs&, SkTypefacePlayback*);
