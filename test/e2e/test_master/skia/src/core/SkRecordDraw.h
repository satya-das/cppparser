...
void SkRecordComputeLayers(const SkRect& cullRect, const SkRecord&, SkRect bounds[], const SkBigPicture::SnapshotArray*, SkLayerInfo* data);
// Draw an SkRecord into an SkCanvas.  A convenience wrapper around SkRecords::Draw.
void SkRecordDraw(const SkRecord&, SkCanvas*, const SkPicture* const drawablePicts[], SkDrawable* const drawables[], int drawableCount, const SkBBoxHierarchy*, SkPicture::AbortCallback*);
...
void SkRecordPartialDraw(const SkRecord&, SkCanvas*, const SkPicture* const drawablePicts[], int drawableCount, int start, int stop, const SkMatrix& initialCTM);
namespace SkRecords
{
// This is an SkRecord visitor that will draw that SkRecord to an SkCanvas.
  ...
  private:
    ...
    SkCanvas* fCanvas;
    const SkPicture* const * fDrawablePicts;
