...
static const SkScalar kStdFakeBoldInterpKeys[] = {SK_Scalar1 * 9, SK_Scalar1 * 36};
static const SkScalar kStdFakeBoldInterpValues[] = {SK_Scalar1 / 24, SK_Scalar1 / 32};
static_assert(SK_ARRAY_COUNT(kStdFakeBoldInterpKeys) == SK_ARRAY_COUNT(kStdFakeBoldInterpValues), "mismatched_array_size");
