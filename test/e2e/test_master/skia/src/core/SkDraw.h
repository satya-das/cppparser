...
public:
  ...
  void drawPoints(SkCanvas::PointMode, size_t count, const SkPoint[], const SkPaint&, SkBaseDevice*) const;
...
private:
  ...
  void drawPath(const SkPath&, const SkPaint&, const SkMatrix* preMatrix, bool pathIsMutable, bool drawCoverage, SkBlitter* customBlitter = nullptr) const;
...
public:
  SkPixmap fDst;
  const SkMatrix* fMatrix{nullptr};
