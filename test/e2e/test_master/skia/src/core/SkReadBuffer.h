...
public:
  ...
  {
    return this->readFlattenable<SkColorFilter>();
  }
  ...
  {
    return this->readFlattenable<SkImageFilter>();
  }
...
public:
  ...
  bool isVersionLT(SkPicturePriv::Version) const
  {
    return false;
  }
  uint32_t getVersion() const
  ...
  const void* skip(size_t)
  {
    return nullptr;
  }
  const void* skip(size_t, size_t)
  {
    return nullptr;
  }
  template <typename T>
  ...
  void readRegion(SkRegion* out)
  {
    *out = SkRegion();
  }
  void readString(SkString* out)
  {
    *out = SkString();
  }
  void readPath(SkPath* out)
  {
    *out = SkPath();
  }
  ...
  bool readPad32(void*, size_t)
  {
    return false;
  }
  bool readByteArray(void*, size_t)
  {
    return false;
  }
  bool readColorArray(SkColor*, size_t)
  {
    return false;
  }
  bool readColor4fArray(SkColor4f*, size_t)
  {
    return false;
  }
  bool readIntArray(int32_t*, size_t)
  {
    return false;
  }
  bool readPointArray(SkPoint*, size_t)
  {
    return false;
  }
  bool readScalarArray(SkScalar*, size_t)
  {
    return false;
  }
  sk_sp<SkData> readByteArrayAsData()
  ...
  SkFilterQuality checkFilterQuality()
  {
    return SkFilterQuality::kNone_SkFilterQuality;
  }
