...
namespace 
{
  ...
  {
    return Sk16h(_mm_unpacklo_epi8(this->fVec, _mm_setzero_si128()), _mm_unpackhi_epi8(this->fVec, _mm_setzero_si128()));
  }
  ...
  inline Sk4px Sk4px::Wide::div255() const
  {
    ...
    const __m128i _128 = _mm_set1_epi16(128), _257 = _mm_set1_epi16(257);
    return Sk4px(_mm_packus_epi16(_mm_mulhi_epu16(_mm_add_epi16(fLo.fVec, _128), _257), _mm_mulhi_epu16(_mm_add_epi16(fHi.fVec, _128), _257)));
  }
...
// These are safe on x86, often with no speed penalty.
  ...
  inline Sk4px Sk4px::alphas() const
  {
    ...
    __m128i as = fVec;
    as = _mm_max_epu8(as, _mm_srli_epi32(as, 8));
    as = _mm_max_epu8(as, _mm_srli_epi32(as, 16));
    return Sk16b(as);
  }
  inline Sk4px Sk4px::Load4Alphas(const SkAlpha a[4])
  {
    __m128i as;
    memcpy(&as, a, 4);
    as = _mm_unpacklo_epi8(as, as);
    as = _mm_unpacklo_epi16(as, as);
    return Sk16b(as);
  }
#endif
  inline Sk4px Sk4px::Load2Alphas(const SkAlpha a[2])
  {
    uint16_t alphas;
    memcpy(&alphas, a, 2);
    uint32_t alphas_and_two_zeros = alphas;
