...
public:
  ...
  static SkBitmapRegionDecoder* Create(SkStreamRewindable* stream, Strategy strategy);
     ...
     *
     */
  virtual bool decodeRegion(SkBitmap* bitmap, SkBRDAllocator* allocator, const SkIRect& desiredSubset, int sampleSize, SkColorType colorType, bool requireUnpremul, sk_sp<SkColorSpace> prefColorSpace = nullptr) = 0;
