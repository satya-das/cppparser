...
public:
  ...
  virtual void deleteTexture(void* textureHandle) = 0;
     ...
     */
  virtual void setTextureData(void* textureHandle, const void* data, int x, int y, int width, int height, size_t rowBytes) = 0;
    /**
     ...
     */
  virtual void drawSDFGlyphs(void* targetHandle, void* textureHandle, const SDFVertex vertices[], int quadCnt) = 0;
