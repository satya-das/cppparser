...
public:
  ...
  bool getPixels(const SkImageInfo& info, void* pixels, size_t rowBytes);
     ...
     */
  bool queryYUVA8(SkYUVASizeInfo* sizeInfo, SkYUVAIndex yuvaIndices[SkYUVAIndex::kIndexCount], SkYUVColorSpace* colorSpace) const;
    /**
     ...
     */
  bool getYUVA8Planes(const SkYUVASizeInfo& sizeInfo, const SkYUVAIndex yuvaIndices[SkYUVAIndex::kIndexCount], void* planes[]);
#  if  SK_SUPPORT_GPU
    /**
     ...
     */
  sk_sp<GrTextureProxy> generateTexture(GrRecordingContext*, const SkImageInfo& info, const SkIPoint& origin, bool willNeedMipMaps);
#  endif
    /**
...
private:
  ...
  SkImageGenerator& operator=(SkImageGenerator&&);
  SkImageGenerator& operator=(const SkImageGenerator&);
};
#endif
