...
{
  return {(int) lrintf(x[0]), (int) lrintf(x[1]), (int) lrintf(x[2]), (int) lrintf(x[3])};
}
#  endif
AI static void Sk4f_ToBytes(uint8_t p[16], const Sk4f& a, const Sk4f& b, const Sk4f& c, const Sk4f& d)
{
