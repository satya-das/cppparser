...
public:
  ...
  virtual Acad::ErrorStatus setAlignment(AcDb::CellAlignment alignment, int rowTypes = AcDb::kAllRows);
  ...
  virtual Acad::ErrorStatus setBackgroundColor(const AcCmColor& color, int rowTypes = AcDb::kAllRows);
  ADESK_DEPRECATED virtual bool isBackgroundColorNone(AcDb::RowType rowType = AcDb::kDataRow) const;
  ADESK_DEPRECATED virtual Acad::ErrorStatus setBackgroundColorNone(bool bValue, int rowTypes = AcDb::kAllRows);
  virtual Acad::ErrorStatus getDataType(AcValue::DataType& nDataType, AcValue::UnitType& nUnitType) const;
    // For internal use only
  ADESK_DEPRECATED virtual Acad::ErrorStatus getDataType(AcValue::DataType& nDataType, AcValue::UnitType& nUnitType, AcDb::RowType rowType) const;
  virtual Acad::ErrorStatus setDataType(AcValue::DataType nDataType, AcValue::UnitType nUnitType);
    // For internal use only
  ADESK_DEPRECATED virtual Acad::ErrorStatus setDataType(AcValue::DataType nDataType, AcValue::UnitType nUnitType, int rowTypes);
  ...
  ADESK_DEPRECATED virtual Acad::ErrorStatus setFormat(const ACHAR* pszFormat);
    // For internal use only
  ADESK_DEPRECATED virtual Acad::ErrorStatus setFormat(const ACHAR* pszFormat, int rowTypes);
    //Gridline properties
    //
  virtual AcDb::LineWeight gridLineWeight(AcDb::GridLineType gridLineType, AcDb::RowType rowType = AcDb::kDataRow) const;
  virtual Acad::ErrorStatus setGridLineWeight(AcDb::LineWeight lineWeight, int gridLineTypes = AcDb::kAllGridLines, int rowTypes = AcDb::kAllRows);
  virtual AcCmColor gridColor(AcDb::GridLineType gridLineType, AcDb::RowType rowType = AcDb::kDataRow) const;
  virtual Acad::ErrorStatus setGridColor(const AcCmColor color, int gridLineTypes = AcDb::kAllGridLines, int rowTypes = AcDb::kAllRows);
  virtual AcDb::Visibility gridVisibility(AcDb::GridLineType gridLineType, AcDb::RowType rowType = AcDb::kDataRow) const;
  ...
  Acad::ErrorStatus copyCellStyle(const AcDbTableStyle* pSrc, const ACHAR* pszSrcCellStyle, const ACHAR* pszTargetCellStyle);
  ...
  Acad::ErrorStatus getDataType(AcValue::DataType& nDataType, AcValue::UnitType& nUnitType, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setDataType(AcValue::DataType nDataType, AcValue::UnitType nUnitType, const ACHAR* pszCellStyle);
  ...
  Acad::ErrorStatus setMargin(AcDb::CellMargin nMargins, double fMargin, const ACHAR* pszCellStyle);
    //Gridline properties
    //
  AcDb::LineWeight gridLineWeight(AcDb::GridLineType gridLineType, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setGridLineWeight(AcDb::LineWeight lineWeight, AcDb::GridLineType gridLineTypes, const ACHAR* pszCellStyle);
  AcCmColor gridColor(AcDb::GridLineType gridLineType, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setGridColor(const AcCmColor color, AcDb::GridLineType gridLineTypes, const ACHAR* pszCellStyle);
  AcDb::Visibility gridVisibility(AcDb::GridLineType gridLineType, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setGridVisibility(AcDb::Visibility visible, AcDb::GridLineType gridLineTypes, const ACHAR* pszCellStyle);
  double gridDoubleLineSpacing(AcDb::GridLineType gridLineType, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setGridDoubleLineSpacing(double fSpacing, AcDb::GridLineType gridLineTypes, const ACHAR* pszCellStyle);
  AcDb::GridLineStyle gridLineStyle(AcDb::GridLineType gridLineType, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setGridLineStyle(AcDb::GridLineStyle nLineStyle, AcDb::GridLineType gridLineTypes, const ACHAR* pszCellStyle);
  AcDbObjectId gridLinetype(AcDb::GridLineType gridLineType, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setGridLinetype(const AcDbObjectId& id, AcDb::GridLineType gridLineTypes, const ACHAR* pszCellStyle);
  Acad::ErrorStatus getGridProperty(AcGridProperty& gridProp, AcDb::GridLineType nGridLineTypes, const ACHAR* pszCellStyle) const;
  Acad::ErrorStatus setGridProperty(const AcGridProperty& gridProp, AcDb::GridLineType nGridLineTypes, const ACHAR* pszCellStyle);
    // Template functions
  AcDbObjectId getTemplate(void) const;
  Acad::ErrorStatus getTemplate(AcDbTableTemplate*& pTemplate, AcDb::OpenMode mode);
  Acad::ErrorStatus setTemplate(const AcDbObjectId& templateId, AcDb::MergeCellStyleOption nOption);
  Acad::ErrorStatus setTemplate(AcDbTableTemplate* pTemplate, AcDb::MergeCellStyleOption nOption, AcDbObjectId& templateId);
