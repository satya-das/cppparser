...
///
  ...
  virtual Acad::ErrorStatus getObject(AcDbObject*& obj, AcDbObjectId id, AcDb::OpenMode mode = AcDb::kForRead, bool openErasedObj = false) = 0;
...
public:
  ...
  virtual Acad::ErrorStatus getObject(AcDbObject*& obj, AcDbObjectId objectId, AcDb::OpenMode mode = AcDb::kForRead, bool openErasedObject = false) = 0;
  virtual Acad::ErrorStatus markObjectPageable(AcDbObject* pObject) = 0;
