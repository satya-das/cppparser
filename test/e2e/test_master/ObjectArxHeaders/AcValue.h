...
public:
  ...
  ACDBCORE2D_PORT explicit AcValue(Adesk::Int32 lValue);
  ACDBCORE2D_PORT AcValue(double fValue);
  ACDBCORE2D_PORT explicit AcValue(const Adesk::Time64& date);
  ...
  ACDBCORE2D_PORT bool parse(const ACHAR* pszText, AcValue::DataType nDataType, AcValue::UnitType nUnitType, const ACHAR* pszFormat, AcValue::ParseOption nOption, const AcDbObjectId* pTextStyleId);
  ...
  ACDBCORE2D_PORT bool convertTo(AcValue::DataType nDataType, AcValue::UnitType nUnitType, bool bResetIfIncompatible);
