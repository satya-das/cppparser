...
public:
  ...
  Acad::ErrorStatus openBlockBegin(AcDbBlockBegin*& pBlockBegin, AcDb::OpenMode openMode = AcDb::kForRead);
  Acad::ErrorStatus openBlockEnd(AcDbBlockEnd*& pBlockEnd, AcDb::OpenMode openMode = AcDb::kForRead);
...
public:
 ...
 kDxfLayerPlotBit = AcDb::kDxfBool
  ...
  Acad::ErrorStatus setTransparency(const AcCmTransparency& trans, const AcDbObjectId& viewportId);
...
public:
  ...
  ACDBCORE2D_PORT Acad::ErrorStatus setFont(const ACHAR* pTypeface, Adesk::Boolean bold, Adesk::Boolean italic, Charset charset, Autodesk::AutoCAD::PAL::FontUtils::FontPitch pitch, Autodesk::AutoCAD::PAL::FontUtils::FontFamily family, bool bAllowMissingFont = false);
    /// <summary>
...
public:
  ...
  Acad::ErrorStatus getEntity(AcDbEntity*& pEntity, AcDb::OpenMode openMode = AcDb::kForRead, bool openErasedEntity = false) const;
...
inline ACHAR* AcDbLayerTableRecord::plotStyleName(const AcDbObjectId& viewportId, bool& isOverride) const
{
  AcString sName;
...
inline Acad::ErrorStatus AcDbTextStyleTableRecord::font(ACHAR*& pTypeface, bool& bold, bool& italic, Charset& charset, Autodesk::AutoCAD::PAL::FontUtils::FontPitch& pitch, Autodesk::AutoCAD::PAL::FontUtils::FontFamily& family) const
{
  pTypeface = nullptr;
  AcString sTypeface;
