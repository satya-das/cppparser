...
#  include "geline2d.h"
#  pragma  pack (push, 8)
class GE_DLLEXPIMPORT AcGeLineSeg2d : public AcGeLinearEnt2d
{
public:
  AcGeLineSeg2d();
  ...
  AcGeLineSeg2d& set(const AcGeCurve2d& curve1, const AcGeCurve2d& curve2, double& param1, double& param2, Adesk::Boolean& success);
  AcGeLineSeg2d& set(const AcGeCurve2d& curve, const AcGePoint2d& point, double& param, Adesk::Boolean& success);
    // Bisector.
    //
