...
class AcGeLineSeg3d;
class GE_DLLEXPIMPORT AcGeNurbCurve3d : public AcGeSplineEnt3d
{
public:
  ...
  AcGeNurbCurve3d(int degree, const AcGeKnotVector& knots, const AcGePoint3dArray& cntrlPnts, const AcGeDoubleArray& weights, Adesk::Boolean isPeriodic = Adesk::kFalse);
    ...
    //
  AcGeNurbCurve3d(int degree, const AcGePolyline3d& fitPolyline, Adesk::Boolean isPeriodic = Adesk::kFalse);
  AcGeNurbCurve3d(const AcGePoint3dArray& fitPoints, const AcGeVector3d& startTangent, const AcGeVector3d& endTangent, Adesk::Boolean startTangentDefined = Adesk::kTrue, Adesk::Boolean endTangentDefined = Adesk::kTrue, const AcGeTol& fitTolerance = AcGeContext::gTol);
    // specify the fitting points and the wanted knot parameterization
  AcGeNurbCurve3d(const AcGePoint3dArray& fitPoints, const AcGeVector3d& startTangent, const AcGeVector3d& endTangent, Adesk::Boolean startTangentDefined, Adesk::Boolean endTangentDefined, AcGe::KnotParameterization knotParam, const AcGeTol& fitTolerance = AcGeContext::gTol);
  ...
  Adesk::Boolean getFitTangents(AcGeVector3d& startTangent, AcGeVector3d& endTangent) const;
  Adesk::Boolean getFitTangents(AcGeVector3d& startTangent, AcGeVector3d& endTangent, Adesk::Boolean& startTangentDefined, Adesk::Boolean& endTangentDefined) const;
  Adesk::Boolean getFitKnotParameterization(KnotParameterization& knotParam) const;
  Adesk::Boolean getFitData(AcGePoint3dArray& fitPoints, AcGeTol& fitTolerance, Adesk::Boolean& tangentsExist, AcGeVector3d& startTangent, AcGeVector3d& endTangent) const;
  Adesk::Boolean getFitData(AcGePoint3dArray& fitPoints, AcGeTol& fitTolerance, Adesk::Boolean& tangentsExist, AcGeVector3d& startTangent, AcGeVector3d& endTangent, KnotParameterization& knotParam) const;
  void getDefinitionData(int& degree, Adesk::Boolean& rational, Adesk::Boolean& periodic, AcGeKnotVector& knots, AcGePoint3dArray& controlPoints, AcGeDoubleArray& weights) const;
  ...
  Adesk::Boolean setFitTangents(const AcGeVector3d& startTangent, const AcGeVector3d& endTangent, Adesk::Boolean startTangentDefined, Adesk::Boolean endTangentDefined) const;
  Adesk::Boolean setFitKnotParameterization(KnotParameterization knotParam);
  AcGeNurbCurve3d& setFitData(const AcGePoint3dArray& fitPoints, const AcGeVector3d& startTangent, const AcGeVector3d& endTangent, const AcGeTol& fitTol = AcGeContext::gTol);
  AcGeNurbCurve3d& setFitData(const AcGePoint3dArray& fitPoints, const AcGeVector3d& startTangent, const AcGeVector3d& endTangent, KnotParameterization knotParam, const AcGeTol& fitTol = AcGeContext::gTol);
  AcGeNurbCurve3d& setFitData(const AcGeKnotVector& fitKnots, const AcGePoint3dArray& fitPoints, const AcGeVector3d& startTangent, const AcGeVector3d& endTangent, const AcGeTol& fitTol = AcGeContext::gTol, Adesk::Boolean isPeriodic = Adesk::kFalse);
  AcGeNurbCurve3d& setFitData(int degree, const AcGePoint3dArray& fitPoints, const AcGeTol& fitTol = AcGeContext::gTol);
  ...
  AcGeNurbCurve3d& hardTrimByParams(double newStartParam, double newEndParam);
