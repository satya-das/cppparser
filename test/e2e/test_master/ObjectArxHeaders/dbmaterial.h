...
public:
  ...
  virtual void setSpecular(const AcGiMaterialColor& color, const AcGiMaterialMap& map, double dGloss);
  ...
  Acad::ErrorStatus normalMap(AcGiMaterialMap& map, AcGiMaterialTraits::NormalMapMethod& method, double& strength) const;
  Acad::ErrorStatus setNormalMap(const AcGiMaterialMap& map, AcGiMaterialTraits::NormalMapMethod method, double strength);
