...
public:
  ...
  virtual void onModified(AcGiDrawable* pModified, Adesk::IntDbId parentID) = 0;
...
public:
  ...
  virtual void currentDisplayDriver(ACHAR* pszPath, int nPathStrLen, ACHAR* pszDriver, int nDriverStrLen, bool& bAccelerated) const = 0;
  virtual void hardwareAcceleratedDriver(ACHAR* pszPath, int nPathStrLen, ACHAR* pszDriver, int nDriverStrLen) const = 0;
...
public:
  ...
  DRAWBRIDGE_API static const AcUniqueString* k3DRapidRTRendering;
};
#ifdef __clang__
...
public:
  ...
  virtual AcGsModel* createModel(AcGsModel::RenderType type, Adesk::IntDbId databaseId, AcGsGetInterfaceFunc getFunc, AcGsReleaseInterfaceFunc releaseFunc) = 0;
    /// <description>
    /// Delete an AcGsModel.
    /// </description>
  ...
  virtual AcGsView* createView(const AcGsClientViewInfo* pClientViewInfo = nullptr, bool bEnableLayerVisibilityPerView = false) = 0;
    /// <description>
...
public:
  ...
  enum RenderingStatus
  {
    ...
    /// during rendering.
    /// </remarks>
  virtual bool OnProgress(Phase ePhase, float fOverallProgress, int iRenderTimeSpent, int iCurrentRenderLevel, float fCurrentLevelProgress, int iTileIndex = 0) = 0;
    /// <description>
