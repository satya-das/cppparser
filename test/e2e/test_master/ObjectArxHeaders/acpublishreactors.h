...
*/
inline void AcPublishReactor::OnAboutToBeginBackgroundPublishing(AcPublishBeforeJobInfo* pInfo)
{
}
inline void AcPublishReactor::OnAboutToBeginPublishing(AcPublishBeginJobInfo* pInfo)
{
}
inline void AcPublishReactor::OnBeginPublishingSheet(AcPublishSheetInfo* pInfo)
{
}
inline void AcPublishReactor::OnBeginAggregation(AcPublishAggregationInfo* pInfo)
{
}
inline void AcPublishReactor::OnAboutToEndPublishing(AcPublishReactorInfo* pInfo)
{
}
inline void AcPublishReactor::OnAboutToMoveFile(AcPublishReactorInfo* pInfo)
{
}
inline void AcPublishReactor::OnEndPublish(AcPublishReactorInfo* pInfo)
{
}
