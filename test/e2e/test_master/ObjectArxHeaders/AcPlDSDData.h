...
public:
  ...
  ACPL_PORT void getUnrecognizedData(AcArray<ACHAR*>& sectionArray, AcArray<ACHAR*>& dataArray) const;
  ACPL_PORT void setUnrecognizedData(const AcArray<ACHAR*>& sectionArray, const AcArray<ACHAR*>& dataArray);
  ACPL_PORT void setUnrecognizedData(const ACHAR* pSectionName, const ACHAR* pSectionData);
  ACPL_PORT void setUnrecognizedData(const AcStringArray& sectionArray, const AcStringArray& dataArray);
