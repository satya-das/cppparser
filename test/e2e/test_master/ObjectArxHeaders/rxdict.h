...
public:
  ...
  virtual AcRxObject* atPut(const ACHAR* key, AcRxObject* pObject, Adesk::UInt32& retId) = 0;
  ...
  virtual Adesk::Boolean atKeyAndIdPut(const ACHAR* newKey, Adesk::UInt32 id, AcRxObject* pObject) = 0;
