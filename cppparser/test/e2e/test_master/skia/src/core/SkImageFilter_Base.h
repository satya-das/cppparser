...
public:
  ...
  skif::FilterResult<For::kOutput> filterImage(const skif::Context& context) const;
     ...
     */
  skif::LayerSpace<SkIRect> getInputBounds(const skif::Mapping& mapping, const skif::DeviceSpace<SkRect>& desiredOutput, const skif::ParameterSpace<SkRect>* knownContentBounds) const;
    /**
     ...
     */
  skif::DeviceSpace<SkIRect> getOutputBounds(const skif::Mapping& mapping, const skif::ParameterSpace<SkRect>& contentBounds) const;
    /**
...
protected:
  ...
  virtual SkIRect onFilterBounds(const SkIRect&, const SkMatrix& ctm, MapDirection, const SkIRect* inputRect) const;
  virtual SkIRect onFilterNodeBounds(const SkIRect&, const SkMatrix& ctm, MapDirection, const SkIRect* inputRect) const;
  ...
  skif::LayerSpace<SkIRect> visitInputLayerBounds(const skif::Mapping& mapping, const skif::LayerSpace<SkIRect>& desiredOutput, const skif::LayerSpace<SkIRect>& contentBounds) const;
    // Helper function to visit each of this filter's child filters and call their
    // onGetOutputLayerBounds with the provided 'contentBounds'. Automatically handles null input
    // filters.
  skif::LayerSpace<SkIRect> visitOutputLayerBounds(const skif::Mapping& mapping, const skif::LayerSpace<SkIRect>& contentBounds) const;
  ...
  bool applyCropRect(const Context&, const SkIRect& srcBounds, SkIRect* dstBounds) const;
     ...
     *  DEPRECATED - Remove once cropping is handled by a separate filter.
     */
  sk_sp<SkSpecialImage> applyCropRectAndPad(const Context&, SkSpecialImage* src, SkIPoint* srcOffset, SkIRect* bounds) const;
    /**
...
#  if  SK_SUPPORT_GPU
  static sk_sp<SkSpecialImage> DrawWithFP(GrRecordingContext* context, std::unique_ptr<GrFragmentProcessor> fp, const SkIRect& bounds, SkColorType colorType, const SkColorSpace* colorSpace, GrProtected isProtected = GrProtected::kNo);
    /**
     ...
     */
  static sk_sp<SkSpecialImage> ImageToColorSpace(SkSpecialImage* src, SkColorType colorType, SkColorSpace* colorSpace);
#  endif
  ...
  static SkIRect DetermineRepeatedSrcBound(const SkIRect& srcBounds, const SkIVector& filterOffset, const SkISize& filterSize, const SkIRect& originalSrcBounds);
private:
  friend class SkImageFilter;
    // For PurgeCache()
  friend class SkGraphics;
  static void PurgeCache();
  void init(const sk_sp<SkImageFilter>* inputs, int inputCount, const CropRect* cropRect);
  ...
  virtual skif::FilterResult<For::kOutput> onFilterImage(const skif::Context& context) const;
     ...
     */
  virtual skif::LayerSpace<SkIRect> onGetInputLayerBounds(const skif::Mapping& mapping, const skif::LayerSpace<SkIRect>& desiredOutput, const skif::LayerSpace<SkIRect>& contentBounds, VisitChildren recurse = VisitChildren::kYes) const;
    /**
  ...
  virtual skif::LayerSpace<SkIRect> onGetOutputLayerBounds(const skif::Mapping& mapping, const skif::LayerSpace<SkIRect>& contentBounds) const;
