...
enum {
kSkBlitterContextSize = 3332
};
// If alloc is non-nullptr, it will be used to allocate the returned SkShader, and MUST outlive
// the SkShader.
sk_sp<SkShader> SkMakeBitmapShader(const SkBitmap& src, SkTileMode, SkTileMode, const SkMatrix* localMatrix, SkCopyPixelsMode);
...
sk_sp<SkShader> SkMakeBitmapShaderForPaint(const SkPaint& paint, const SkBitmap& src, SkTileMode, SkTileMode, const SkMatrix* localMatrix, SkCopyPixelsMode);
/**
 ...
 *  nullptr.
 */
SK_API extern sk_sp<SkImage> SkMakeImageFromRasterBitmap(const SkBitmap&, SkCopyPixelsMode);
