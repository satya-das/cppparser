...
{
public:
  static std::unique_ptr<GrFragmentProcessor> Make(sk_sp<GrTextureProxy> srcProxy, const SkIRect& srcBounds, const SkISize& kernelSize, const SkScalar* kernel, SkScalar gain, SkScalar bias, const SkIPoint& kernelOffset, GrTextureDomain::Mode tileMode, bool convolveAlpha)
  {
    return std::unique_ptr<GrFragmentProcessor>(new GrMatrixConvolutionEffect(std::move(srcProxy), srcBounds, kernelSize, kernel, gain, bias, kernelOffset, tileMode, convolveAlpha));
  }
...
private:
  ...
  GrMatrixConvolutionEffect(sk_sp<GrTextureProxy> srcProxy, const SkIRect& srcBounds, const SkISize& kernelSize, const SkScalar* kernel, SkScalar gain, SkScalar bias, const SkIPoint& kernelOffset, GrTextureDomain::Mode tileMode, bool convolveAlpha);
