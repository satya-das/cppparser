...
public:
    ...
    : fStyle(style)
  {
    ...
    fRRectData.fStart = DefaultRRectDirAndStartIndex(rrect, style.hasPathEffect(), &fRRectData.fDir);
    ...
    : fStyle(style)
  {
    ...
    fRRectData.fInverted = false;
    fRRectData.fStart = DefaultRectDirAndStartIndex(rect, style.hasPathEffect(), &fRRectData.fDir);
    this->attemptToSimplifyRRect();
  }
    ...
    : fStyle(paint)
  {
    ...
    fRRectData.fRRect = rrect;
    fRRectData.fInverted = false;
    fRRectData.fStart = DefaultRRectDirAndStartIndex(rrect, fStyle.hasPathEffect(), &fRRectData.fDir);
    this->attemptToSimplifyRRect();
  }
    ...
    : fStyle(paint)
  {
    ...
    fRRectData.fRRect = SkRRect::MakeRect(rect);
    fRRectData.fInverted = false;
    fRRectData.fStart = DefaultRectDirAndStartIndex(rect, fStyle.hasPathEffect(), &fRRectData.fDir);
    this->attemptToSimplifyRRect();
  }
  ...
  void asPath(SkPath* out) const
  {
    switch(fType)
    {
      ...
      case Type::kRRect:
        ...
        break;
      case Type::kArc:
        SkPathPriv::CreateDrawArcPath(out, fArcData.fOval, fArcData.fStartAngleDegrees, fArcData.fSweepAngleDegrees, fArcData.fUseCenter, fStyle.isSimpleFill());
  ...
  bool knownToBeConvex() const
  {
    switch(fType)
    {
      ...
      case Type::kRRect:
        return true;
      case Type::kArc:
        return SkPathPriv::DrawArcIsConvex(fArcData.fSweepAngleDegrees, SkToBool(fArcData.fUseCenter), fStyle.isSimpleFill());
      case Type::kLine:
        return true;
      case Type::kPath:
  ...
  bool knownDirection() const
  {
    switch(fType)
    {
      ...
      case Type::kLine:
        return true;
      case Type::kPath:
        return !SkPathPriv::CheapIsFirstDirection(this->path(), SkPathPriv::kUnknown_FirstDirection);
    }
    return false;
  }
  ...
  uint32_t segmentMask() const
  {
    switch(fType)
    {
      ...
      case Type::kRRect:
        ...
        {
          if (fRRectData.fRRect.getType() == SkRRect::kRect_Type || fRRectData.fRRect.getType() == SkRRect::kEmpty_Type)
          {
