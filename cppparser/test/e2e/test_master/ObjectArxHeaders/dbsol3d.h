...
public:
  ...
  virtual Acad::ErrorStatus createPyramid(double height, int sides, double radius, double topRadius = 0.0);
  ...
  virtual Acad::ErrorStatus checkInterference(const AcDb3dSolid* otherSolid, Adesk::Boolean createNewSolid, Adesk::Boolean& solidsInterfere, AcDb3dSolid*& commonVolumeSolid) const;
  virtual Acad::ErrorStatus getMassProp(double& volume, AcGePoint3d& centroid, double momInertia[3], double prodInertia[3], double prinMoments[3], AcGeVector3d prinAxes[3], double radiiGyration[3], AcDbExtents& extents) const;
  ...
  virtual Acad::ErrorStatus extrudeFaces(const AcArray<AcDbSubentId *>& faceSubentIds, double height, double taper);
  virtual Acad::ErrorStatus extrudeFacesAlongPath(const AcArray<AcDbSubentId *>& faceSubentIds, const AcDbCurve* path);
  ...
  ACDB_PORT virtual Acad::ErrorStatus offsetFaces(const AcArray<AcDbSubentId *>& faceSubentIds, double offsetDistance);
  ...
  virtual Acad::ErrorStatus shellBody(const AcArray<AcDbSubentId *>& faceSubentIds, double offsetDistance);
  virtual Acad::ErrorStatus taperFaces(const AcArray<AcDbSubentId *>& faceSubentIds, const AcGePoint3d& basePoint, const AcGeVector3d& draftVector, double draftAngle);
  virtual Acad::ErrorStatus transformFaces(const AcArray<AcDbSubentId *>& faceSubentIds, const AcGeMatrix3d& matrix);
