...
#  elif  defined(__WXMSW__)
  ...
  wxNativeFontInfo(const LOGFONT& lf_, const wxWindow* win = NULL);
...
WXDLLIMPEXP_CORE bool wxGetNativeFontEncoding(wxFontEncoding encoding, wxNativeEncodingInfo* info);
