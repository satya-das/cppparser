...
static GtkWidget* wx_gtk_scrolled_window_get_hscrollbar(GtkScrolledWindow* scrolled_window)
{
  return scrolled_window->hscrollbar;
}
#    define gtk_scrolled_window_get_hscrollbar	wx_gtk_scrolled_window_get_hscrollbar
static GtkWidget* wx_gtk_scrolled_window_get_vscrollbar(GtkScrolledWindow* scrolled_window)
{
...
static gpointer wx_g_object_ref_sink(gpointer object)
{
  g_object_ref(object);
...
static void wx_gtk_about_dialog_set_program_name(GtkAboutDialog* about, const gchar* name)
{
...
static void wx_gtk_adjustment_set_page_increment(GtkAdjustment* adjustment, gdouble page_increment)
{
  adjustment->page_increment = page_increment;
  gtk_adjustment_changed(adjustment);
}
#    define gtk_adjustment_set_page_increment	wx_gtk_adjustment_set_page_increment
static void wx_gtk_adjustment_set_page_size(GtkAdjustment* adjustment, gdouble page_size)
{
  adjustment->page_size = page_size;
}
#    define gtk_adjustment_set_page_size	wx_gtk_adjustment_set_page_size
static GtkWidget* wx_gtk_color_selection_dialog_get_color_selection(GtkColorSelectionDialog* csd)
{
  return csd->colorsel;
}
#    define gtk_color_selection_dialog_get_color_selection	wx_gtk_color_selection_dialog_get_color_selection
static GtkWidget* wx_gtk_dialog_get_content_area(GtkDialog* dialog)
{
  return dialog->vbox;
}
#    define gtk_dialog_get_content_area	wx_gtk_dialog_get_content_area
static GtkWidget* wx_gtk_dialog_get_action_area(GtkDialog* dialog)
{
  return dialog->action_area;
}
#    define gtk_dialog_get_action_area	wx_gtk_dialog_get_action_area
static guint16 wx_gtk_entry_get_text_length(GtkEntry* entry)
{
  return entry->text_length;
}
#    define gtk_entry_get_text_length	wx_gtk_entry_get_text_length
static const guchar* wx_gtk_selection_data_get_data(GtkSelectionData* selection_data)
{
  return selection_data->data;
}
#    define gtk_selection_data_get_data	wx_gtk_selection_data_get_data
static GdkAtom wx_gtk_selection_data_get_data_type(GtkSelectionData* selection_data)
{
  return selection_data->type;
}
#    define gtk_selection_data_get_data_type	wx_gtk_selection_data_get_data_type
static gint wx_gtk_selection_data_get_format(GtkSelectionData* selection_data)
{
  return selection_data->format;
}
#    define gtk_selection_data_get_format	wx_gtk_selection_data_get_format
static gint wx_gtk_selection_data_get_length(GtkSelectionData* selection_data)
{
  return selection_data->length;
}
#    define gtk_selection_data_get_length	wx_gtk_selection_data_get_length
static GdkAtom wx_gtk_selection_data_get_target(GtkSelectionData* selection_data)
{
  return selection_data->target;
}
#    define gtk_selection_data_get_target	wx_gtk_selection_data_get_target
static GdkWindow* wx_gtk_widget_get_window(GtkWidget* widget)
{
  return widget->window;
}
#    define gtk_widget_get_window	wx_gtk_widget_get_window
static GtkWidget* wx_gtk_window_get_default_widget(GtkWindow* window)
{
...
static GdkAtom wx_gtk_selection_data_get_selection(GtkSelectionData* selection_data)
{
...
static void wx_gtk_cell_renderer_get_alignment(GtkCellRenderer* cell, gfloat* xalign, gfloat* yalign)
{
  *xalign = cell->xalign;
  *yalign = cell->yalign;
}
#    define gtk_cell_renderer_get_alignment	wx_gtk_cell_renderer_get_alignment
static void wx_gtk_cell_renderer_get_padding(GtkCellRenderer* cell, gint* xpad, gint* ypad)
{
  *xpad = cell->xpad;
  *ypad = cell->ypad;
}
#    define gtk_cell_renderer_get_padding	wx_gtk_cell_renderer_get_padding
static void wx_gtk_cell_renderer_set_padding(GtkCellRenderer* cell, gint xpad, gint ypad)
{
  cell->xpad = xpad;
  cell->ypad = ypad;
}
#    define gtk_cell_renderer_set_padding	wx_gtk_cell_renderer_set_padding
static void wx_gtk_widget_get_allocation(GtkWidget* widget, GtkAllocation* allocation)
{
...
static gboolean wx_gtk_widget_has_focus(GtkWidget* widget)
{
...
static gboolean wx_gtk_widget_has_grab(GtkWidget* widget)
{
  return GTK_WIDGET_HAS_GRAB(widget);
}
#    define gtk_widget_has_grab	wx_gtk_widget_has_grab
static void wx_gtk_widget_set_allocation(GtkWidget* widget, const GtkAllocation* allocation)
{
  widget->allocation = *allocation;
}
#    define gtk_widget_set_allocation	wx_gtk_widget_set_allocation
static gboolean wx_gtk_widget_is_toplevel(GtkWidget* widget)
{
...
static void wx_gtk_widget_get_requisition(GtkWidget* widget, GtkRequisition* requisition)
{
  *requisition = widget->requisition;
}
#    define gtk_widget_get_requisition	wx_gtk_widget_get_requisition
static GdkWindow* wx_gtk_entry_get_text_window(GtkEntry* entry)
{
...
static GdkWindow* wx_gtk_button_get_event_window(GtkButton* button)
{
  return button->event_window;
}
#    define gtk_button_get_event_window	wx_gtk_button_get_event_window
static GdkDragAction wx_gdk_drag_context_get_actions(GdkDragContext* context)
{
  return context->actions;
}
#    define gdk_drag_context_get_actions	wx_gdk_drag_context_get_actions
static GdkDragAction wx_gdk_drag_context_get_selected_action(GdkDragContext* context)
{
  return context->action;
}
#    define gdk_drag_context_get_selected_action	wx_gdk_drag_context_get_selected_action
static GdkDragAction wx_gdk_drag_context_get_suggested_action(GdkDragContext* context)
{
  return context->suggested_action;
}
#    define gdk_drag_context_get_suggested_action	wx_gdk_drag_context_get_suggested_action
static GList* wx_gdk_drag_context_list_targets(GdkDragContext* context)
{
  return context->targets;
}
#    define gdk_drag_context_list_targets	wx_gdk_drag_context_list_targets
static gint wx_gdk_visual_get_depth(GdkVisual* visual)
{
  return visual->depth;
}
#    define gdk_visual_get_depth	wx_gdk_visual_get_depth
static gboolean wx_gtk_window_has_group(GtkWindow* window)
{
...
static gint wx_gdk_window_get_width(GdkWindow* window)
{
  int w;
...
static void wx_gdk_cairo_set_source_window(cairo_t* cr, GdkWindow* window, gdouble x, gdouble y)
{
...
static void wx_gdk_window_get_geometry(GdkWindow* window, gint* x, gint* y, gint* width, gint* height)
{
  gdk_window_get_geometry(window, x, y, width, height, NULL);
}
#    define gdk_window_get_geometry	wx_gdk_window_get_geometry
static GtkWidget* wx_gtk_tree_view_column_get_button(GtkTreeViewColumn* tree_column)
{
  return tree_column->button;
}
#    define gtk_tree_view_column_get_button	wx_gtk_tree_view_column_get_button
static GtkWidget* wx_gtk_box_new(GtkOrientation orientation, gint spacing)
{
  GtkWidget* widget;
...
static GtkWidget* wx_gtk_button_box_new(GtkOrientation orientation)
{
  GtkWidget* widget;
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
  {
...
static GtkWidget* wx_gtk_scale_new(GtkOrientation orientation, GtkAdjustment* adjustment)
{
  GtkWidget* widget;
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
  {
...
static GtkWidget* wx_gtk_scrollbar_new(GtkOrientation orientation, GtkAdjustment* adjustment)
{
  GtkWidget* widget;
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
  {
...
static GtkWidget* wx_gtk_separator_new(GtkOrientation orientation)
{
  GtkWidget* widget;
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
  {
...
static void wx_gtk_widget_get_preferred_height(GtkWidget* widget, gint* minimum, gint* natural)
{
  GtkRequisition req;
...
static void wx_gtk_widget_get_preferred_width(GtkWidget* widget, gint* minimum, gint* natural)
{
  GtkRequisition req;
  gtk_widget_size_request(widget, &req);
  if (minimum)
...
static void wx_gtk_widget_get_preferred_size(GtkWidget* widget, GtkRequisition* minimum, GtkRequisition* natural)
{
...
inline bool wx_is_at_least_gtk2(int)
{
  return true;
}
#  endif
