...
protected:
  ...
  bool TestButtonHover(const wxRect& rect, wxPoint pos, wxRibbonGalleryButtonState* state);
...
public:
  ...
  wxRibbonGalleryEvent(const wxRibbonGalleryEvent& e)
    : wxCommandEvent(e)
  {
  ...
  {
    return new wxRibbonGalleryEvent(*this);
  }
...
typedef void (*wxRibbonGalleryEventFunction) (wxRibbonGalleryEvent&);
