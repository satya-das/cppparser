...
public:
  ...
  {
    return new wxRibbonBarEvent(*this);
  }
...
public:
  ...
  {
    return m_arePanelsShown;
  }
  wxRibbonDisplayMode GetDisplayMode() const
  {
    return m_ribbon_state;
  }
  ...
  {
    return m_toggle_button_hovered;
  }
  bool IsHelpButtonHovered() const
  {
    return m_help_button_hovered;
  }
  void HideIfExpanded();
...
typedef void (*wxRibbonBarEventFunction) (wxRibbonBarEvent&);
