...
public:
  ...
  virtual bool GetButtonBarButtonSize(wxDC& dc, wxWindow* wnd, wxRibbonButtonKind kind, wxRibbonButtonBarButtonState size, const wxString& label, wxCoord text_min_width, wxSize bitmap_size_large, wxSize bitmap_size_small, wxSize* button_size, wxRect* normal_region, wxRect* dropdown_region) = 0;
  virtual wxCoord GetButtonBarButtonTextWidth(wxDC& dc, const wxString& label, wxRibbonButtonKind kind, wxRibbonButtonBarButtonState size) = 0;
...
public:
  ...
  void GetColourScheme(wxColour* primary, wxColour* secondary, wxColour* tertiary) const override;
  void SetColourScheme(const wxColour& primary, const wxColour& secondary, const wxColour& tertiary) override;
  int GetTabCtrlHeight(wxDC& dc, wxWindow* wnd, const wxRibbonPageTabInfoArray& pages) override;
  ...
  void DrawScrollButton(wxDC& dc, wxWindow* wnd, const wxRect& rect, long style) override;
  void DrawPanelBackground(wxDC& dc, wxRibbonPanel* wnd, const wxRect& rect) override;
  void DrawGalleryBackground(wxDC& dc, wxRibbonGallery* wnd, const wxRect& rect) override;
  void DrawGalleryItemBackground(wxDC& dc, wxRibbonGallery* wnd, const wxRect& rect, wxRibbonGalleryItem* item) override;
  ...
  void DrawToggleButton(wxDC& dc, wxRibbonBar* wnd, const wxRect& rect, wxRibbonDisplayMode mode) override;
  void DrawHelpButton(wxDC& dc, wxRibbonBar* wnd, const wxRect& rect) override;
  void GetBarTabWidth(wxDC& dc, wxWindow* wnd, const wxString& label, const wxBitmap& bitmap, int* ideal, int* small_begin_need_separator, int* small_must_have_separator, int* minimum) override;
  wxSize GetScrollButtonMinimumSize(wxDC& dc, wxWindow* wnd, long style) override;
  wxSize GetPanelSize(wxDC& dc, const wxRibbonPanel* wnd, wxSize client_size, wxPoint* client_offset) override;
  wxSize GetPanelClientSize(wxDC& dc, const wxRibbonPanel* wnd, wxSize size, wxPoint* client_offset) override;
  wxRect GetPanelExtButtonArea(wxDC& dc, const wxRibbonPanel* wnd, wxRect rect) override;
  wxSize GetGallerySize(wxDC& dc, const wxRibbonGallery* wnd, wxSize client_size) override;
  wxSize GetGalleryClientSize(wxDC& dc, const wxRibbonGallery* wnd, wxSize size, wxPoint* client_offset, wxRect* scroll_up_button, wxRect* scroll_down_button, wxRect* extension_button) override;
  wxRect GetPageBackgroundRedrawArea(wxDC& dc, const wxRibbonPage* wnd, wxSize page_old_size, wxSize page_new_size) override;
  bool GetButtonBarButtonSize(wxDC& dc, wxWindow* wnd, wxRibbonButtonKind kind, wxRibbonButtonBarButtonState size, const wxString& label, wxCoord text_min_width, wxSize bitmap_size_large, wxSize bitmap_size_small, wxSize* button_size, wxRect* normal_region, wxRect* dropdown_region) override;
  wxCoord GetButtonBarButtonTextWidth(wxDC& dc, const wxString& label, wxRibbonButtonKind kind, wxRibbonButtonBarButtonState size) override;
  wxSize GetMinimisedPanelMinimumSize(wxDC& dc, const wxRibbonPanel* wnd, wxSize* desired_bitmap_size, wxDirection* expanded_panel_direction) override;
  wxSize GetToolSize(wxDC& dc, wxWindow* wnd, wxSize bitmap_size, wxRibbonButtonKind kind, bool is_first, bool is_last, wxRect* dropdown_region) override;
...
protected:
  ...
  void DrawGalleryBackgroundCommon(wxDC& dc, wxRibbonGallery* wnd, const wxRect& rect);
  virtual void DrawGalleryButton(wxDC& dc, wxRect rect, wxRibbonGalleryButtonState state, wxBitmap* bitmaps);
...
public:
  ...
  void DrawTool(wxDC& dc, wxWindow* wnd, const wxRect& rect, const wxBitmap& bitmap, wxRibbonButtonKind kind, long state) override;
protected:
  void DrawPartialPanelBackground(wxDC& dc, wxWindow* wnd, const wxRect& rect);
  void DrawGalleryButton(wxDC& dc, wxRect rect, wxRibbonGalleryButtonState state, wxBitmap* bitmaps) override;
