...
public:
  ...
  wxUString(const wxScopedU32CharBuffer& buf)
  {
    assign(buf);
  }
  ...
  wxUString(const wxScopedCharBuffer& buf)
  {
    assign(buf);
  }
  ...
  wxUString(const wxScopedCharBuffer& buf, const wxMBConv& conv)
  {
    assign(buf, conv);
  }
  ...
  wxUString(const wxScopedU16CharBuffer& buf)
  {
    assign(buf);
  }
  wxUString(const wxCStrData* cstr)
  {
    assign(cstr);
  }
