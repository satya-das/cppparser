...
#      undef error "wxSelect/EpollDispatcher needed for console event loop"
...
#    ifdef wxABORT_ON_CONFIG_ERROR
#      undef error "wxFileSystemWatcher requires either inotify() or kqueue()"
...
#  if  !wxUSE_THREADS
#    ifdef wxABORT_ON_CONFIG_ERROR
#      undef error "GStreamer requires threads"
...
#ifndef wxUSE_XTEST
#  ifdef wxABORT_ON_CONFIG_ERROR
#    undef error "wxUSE_XTEST must be defined, please read comment near the top of this file."
