...
protected:
  ...
  wxWxCharBuffer m_delims;
  size_t m_delimsLen;
  wxString::const_iterator m_pos;
...
wxArrayString WXDLLIMPEXP_BASE wxStringTokenize(const wxString& str, const wxString& delims = wxDEFAULT_DELIMITERS, wxStringTokenizerMode mode = wxTOKEN_DEFAULT);
#endif
