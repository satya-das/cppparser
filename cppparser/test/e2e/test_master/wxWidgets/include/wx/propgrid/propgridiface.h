...
public:
  ...
  wxPGPropArgCls(wxString* str, bool)
  {
    m_ptr.stringName = str;
  ...
  bool HasName() const
  {
    return (m_flags != IsProperty);
  }
  const wxString& GetName() const
  {
    return *m_ptr.stringName;
  }
private:
  enum
  {
...
// -----------------------------------------------------------------------
WXDLLIMPEXP_PROPGRID void wxPGTypeOperationFailed(const wxPGProperty* p, const wxString& typestr, const wxString& op);
WXDLLIMPEXP_PROPGRID void wxPGGetFailed(const wxPGProperty* p, const wxString& typestr);
// -----------------------------------------------------------------------
...
#    endif
  ...
  wxPropertyGridPageState* GetState() const
  {
    return m_pState;
  }
...
protected:
  bool DoClearSelection(bool validation = false, int selFlags = 0);
