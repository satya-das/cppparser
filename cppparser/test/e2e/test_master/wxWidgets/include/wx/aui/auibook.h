...
public:
  ...
  {
    return new wxAuiNotebookEvent(*this);
  }
...
class WXDLLIMPEXP_AUI wxAuiTabCtrl : public wxControl, public wxAuiTabContainer
{
public:
...
public:
  ...
  bool InsertPage(size_t pageIdx, wxWindow* page, const wxString& caption, bool select = false, const wxBitmap& bitmap = wxNullBitmap);
  ...
  bool AddPage(wxWindow* page, const wxString& text, bool select, int imageId) override;
  bool DeleteAllPages() override;
  bool InsertPage(size_t index, wxWindow* page, const wxString& text, bool select, int imageId) override;
...
protected:
  ...
  wxWindow* DoRemovePage(size_t) override
  {
    return NULL;
  }
...
typedef void (*wxAuiNotebookEventFunction) (wxAuiNotebookEvent&);
