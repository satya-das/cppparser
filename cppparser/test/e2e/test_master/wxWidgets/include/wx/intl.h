...
public:
  ...
  const wxString& GetString(const wxString& origString, const wxString& origString2, unsigned n, const wxString& domain = wxEmptyString) const
  {
...
private:
  ...
  void DoInit(const wxString& name, const wxString& shortName, int language);
  ...
  bool DoCommonPostInit(bool success, const wxString& name, const wxString& shortName, bool bLoadDefault);
  wxString m_strLocale, m_strShort;
  int m_language;
...
WXDLLIMPEXP_BASE extern wxLocale* wxGetLocale();
#  endif
#endif
