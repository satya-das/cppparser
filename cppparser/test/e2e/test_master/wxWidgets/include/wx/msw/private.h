...
// ---------------------------------------------------------------------------
#  if  wxUSE_GUI
WXDLLIMPEXP_CORE extern HICON wxSTD_FRAME_ICON;
WXDLLIMPEXP_CORE extern HICON wxSTD_MDIPARENTFRAME_ICON;
WXDLLIMPEXP_CORE extern HICON wxSTD_MDICHILDFRAME_ICON;
WXDLLIMPEXP_CORE extern HICON wxDEFAULT_FRAME_ICON;
WXDLLIMPEXP_CORE extern HICON wxDEFAULT_MDIPARENTFRAME_ICON;
WXDLLIMPEXP_CORE extern HICON wxDEFAULT_MDICHILDFRAME_ICON;
WXDLLIMPEXP_CORE extern HFONT wxSTATUS_LINE_FONT;
#  endif
// ---------------------------------------------------------------------------
// global data
// ---------------------------------------------------------------------------
WXDLLIMPEXP_BASE extern HINSTANCE wxhInstance;
extern "C" {
...
inline int wxGetEditHeightFromCharHeight(int cy, const wxWindow*)
{
...
extern LONG APIENTRY wxSubclassedGenericControlProc(WXHWND hWnd, WXUINT message, WXWPARAM wParam, WXLPARAM lParam);
#  endif
// ---------------------------------------------------------------------------
...
// size.
extern HCURSOR wxBitmapToHCURSOR(const wxBitmap& bmp, int hotSpotX, int hotSpotY);
extern int wxGetSystemMetrics(int nIndex, const wxWindow* win);
extern bool wxSystemParametersInfo(UINT uiAction, UINT uiParam, PVOID pvParam, UINT fWinIni, const wxWindow* win);
...
extern BOOL wxDrawStateBitmap(HDC hDC, HBITMAP hBitmap, int x, int y, UINT uState);
#    endif
...
WXDLLIMPEXP_CORE extern int wxGetWindowId(WXHWND hWnd);
...
WXDLLIMPEXP_CORE extern bool wxCheckWindowWndProc(WXHWND hWnd, WXWNDPROC wndProc = NULL);
...
WXDLLIMPEXP_CORE extern wxWindow* wxFindWinFromHandle(HWND hwnd);
...
WXDLLIMPEXP_CORE extern wxWindow* wxGetWindowFromHWND(WXHWND hwnd);
// Get the size of an icon
WXDLLIMPEXP_CORE extern wxSize wxGetHiconSize(HICON hicon);
