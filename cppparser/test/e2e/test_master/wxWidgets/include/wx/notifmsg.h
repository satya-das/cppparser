...
public:
  ...
  wxNotificationMessageBase(const wxString& title, const wxString& message = wxEmptyString, wxWindow* parent = NULL, int flags = wxICON_INFORMATION)
  {
    Init();
...
protected:
  ...
  void Create(const wxString& title = wxEmptyString, const wxString& message = wxEmptyString, wxWindow* parent = NULL, int flags = wxICON_INFORMATION)
  {
    SetTitle(title);
    SetMessage(message);
    SetParent(parent);
...
#    endif
class WXDLLIMPEXP_CORE wxNotificationMessage : public wxNotificationMessageBase
{
public:
  wxNotificationMessage()
  {
  ...
  wxNotificationMessage(const wxString& title, const wxString& message = wxString(), wxWindow* parent = NULL, int flags = wxICON_INFORMATION)
  {
    Init();
    Create(title, message, parent, flags);
  }
