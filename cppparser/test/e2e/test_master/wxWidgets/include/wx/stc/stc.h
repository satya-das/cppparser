...
#    endif
  ...
  bool SetStyle(long, long, const wxTextAttr&) override
  {
    wxFAIL_MSG("not implemented");
    return false;
  }
  bool GetStyle(long, wxTextAttr&) override
  {
    wxFAIL_MSG("not implemented");
    return false;
  }
  bool SetDefaultStyle(const wxTextAttr&) override
  {
    wxFAIL_MSG("not implemented");
    return false;
  }
  ...
  wxTextCtrlHitTestResult HitTest(const wxPoint& pt, wxTextCoord* col, wxTextCoord* row) const override
  {
    ...
    // ---------------------------------------------
  wxDEPRECATED_MSG("use UsePopUp(int) instead.") void UsePopUp(bool allowPopUp);
  wxDEPRECATED_MSG("use StartStyling(int start) instead.") void StartStyling(int start, int unused);
...
typedef void (*wxStyledTextEventFunction) (wxStyledTextEvent&);
