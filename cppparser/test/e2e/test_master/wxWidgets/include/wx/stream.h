...
public:
  ...
  {
    return GetLastError() == wxSTREAM_NO_ERROR;
  }
  bool operator!() const
  {
    return !IsOk();
...
public:
  ...
  {
    return wxStreamBase::m_lastcount;
  }
  ...
  virtual wxFileOffset TellI() const;
    ...
    // ---------------------
  wxInputStream& operator>>(wxOutputStream& out)
  {
    return Read(out);
  }
  wxInputStream& operator>>(__wxInputManip func)
  {
    return func(*this);
  }
protected:
...
public:
  ...
  wxOutputStream& operator<<(wxInputStream& out)
  {
    return Write(out);
  }
  wxOutputStream& operator<<(__wxOutputManip func)
  {
    return func(*this);
  }
protected:
...
public:
  ...
  {
    return m_buffer_pos - m_buffer_start;
  }
  ...
  size_t GetDataLeft();
    // misc accessors
  wxStreamBase* GetStream() const
  {
    return m_stream;
  }
  bool HasBuffer() const
  {
    return m_buffer_start != m_buffer_end;
  }
  bool IsFixed() const
  {
    return m_fixed;
...
protected:
  ...
  BufMode m_mode;
    // flags
  bool m_destroybuf, m_fixed, m_flushable;
...
protected:
  ...
  {
    const_cast<wxWrapperInputStream*>(this)->Reset(m_parent_i_stream->GetLastError());
  }
