...
WXDLLIMPEXP_CORE extern const char wxFilePickerWidgetLabel[];
WXDLLIMPEXP_CORE extern const char wxFilePickerWidgetNameStr[];
WXDLLIMPEXP_CORE extern const char wxFilePickerCtrlNameStr[];
WXDLLIMPEXP_CORE extern const char wxFileSelectorPromptStr[];
WXDLLIMPEXP_CORE extern const char wxDirPickerWidgetLabel[];
WXDLLIMPEXP_CORE extern const char wxDirPickerWidgetNameStr[];
WXDLLIMPEXP_CORE extern const char wxDirPickerCtrlNameStr[];
WXDLLIMPEXP_CORE extern const char wxDirSelectorPromptStr[];
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
typedef void (*wxFileDirPickerEventFunction) (wxFileDirPickerEvent&);
...
protected:
  ...
  bool CreateBase(wxWindow* parent, wxWindowID id, const wxString& path, const wxString& message, const wxString& wildcard, const wxPoint& pos, const wxSize& size, long style, const wxValidator& validator, const wxString& name);
public:
  wxString GetPath() const;
