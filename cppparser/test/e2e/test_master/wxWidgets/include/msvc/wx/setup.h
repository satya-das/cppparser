...
// will be used from
#ifdef WXUSINGDLL
#  define wxLIB_SUBDIR	wxCONCAT4(wxCOMPILER_PREFIX, wxARCH_SUFFIX, _dll, wxCFG)
#else 
#  define wxLIB_SUBDIR	wxCONCAT4(wxCOMPILER_PREFIX, wxARCH_SUFFIX, _lib, wxCFG)
#endif
...
#ifdef wxSUFFIX
#  define wxSETUPH_PATH	wxCONCAT6(../../../lib/, wxLIB_SUBDIR, /, wxTOOLKIT_PREFIX, wxSUFFIX, /wx/setup.h)
#else 
#  define wxSETUPH_PATH	wxCONCAT5(../../../lib/, wxLIB_SUBDIR, /, wxTOOLKIT_PREFIX, /wx/setup.h)
#endif
