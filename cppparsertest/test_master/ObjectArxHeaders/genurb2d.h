...
public:
	...
	Adesk::Boolean getFitTangents(AcGeVector2d& startTangent, AcGeVector2d& endTangent) const;
	Adesk::Boolean getFitKnotParameterization(KnotParameterization& knotParam) const;
	Adesk::Boolean getFitData(AcGePoint2dArray& fitPoints, AcGeTol& fitTolerance, Adesk::Boolean& tangentsExist, AcGeVector2d& startTangent, AcGeVector2d& endTangent) const;
	Adesk::Boolean getFitData(AcGePoint2dArray& fitPoints, AcGeTol& fitTolerance, Adesk::Boolean& tangentsExist, AcGeVector2d& startTangent, AcGeVector2d& endTangent, KnotParameterization& knotParam) const;
	void getDefinitionData(int& degree, Adesk::Boolean& rational, Adesk::Boolean& periodic, AcGeKnotVector& knots, AcGePoint2dArray& controlPoints, AcGeDoubleArray& weights) const;
	...
	AcGeNurbCurve2d& setFitData(const AcGePoint2dArray& fitPoints, const AcGeVector2d& startTangent, const AcGeVector2d& endTangent, const AcGeTol& fitTol = AcGeContext::gTol);
	AcGeNurbCurve2d& setFitData(const AcGePoint2dArray& fitPoints, const AcGeVector2d& startTangent, const AcGeVector2d& endTangent, KnotParameterization knotParam, const AcGeTol& fitTol = AcGeContext::gTol);
	AcGeNurbCurve2d& setFitData(const AcGeKnotVector& fitKnots, const AcGePoint2dArray& fitPoints, const AcGeVector2d& startTangent, const AcGeVector2d& endTangent, const AcGeTol& fitTol = AcGeContext::gTol, Adesk::Boolean isPeriodic = Adesk::kFalse);
	AcGeNurbCurve2d& setFitData(int degree, const AcGePoint2dArray& fitPoints, const AcGeTol& fitTol = AcGeContext::gTol);
	...
	AcGeNurbCurve2d& hardTrimByParams(double newStartParam, double newEndParam);
