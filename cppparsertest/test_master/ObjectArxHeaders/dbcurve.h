...
public:
  ...
  ACDBCORE2D_PORT virtual Acad::ErrorStatus getAcGeCurve(AcGeCurve3d*& pGeCurve, const AcGeTol& tol = AcGeContext::gTol) const;
    /// <summary>
    ...
    /// <param name="tol">Optional input tolerance.</param>
    /// <returns>Returns eOk if successful.</returns>
  ACDBCORE2D_PORT static Acad::ErrorStatus createFromAcGeCurve(const AcGeCurve3d& geCurve, AcDbCurve*& pDbCurve, AcGeVector3d* normal = NULL, const AcGeTol& tol = AcGeContext::gTol);
    /// <summary>
    ...
    /// <param name="tol">Optional input tolerance.</param>
    /// <returns>Returns eOk if successful.</returns>
  ACDBCORE2D_PORT virtual Acad::ErrorStatus setFromAcGeCurve(const AcGeCurve3d& geCurve, AcGeVector3d* normal = NULL, const AcGeTol& tol = AcGeContext::gTol);
protected:
  AcDbCurve();
};
