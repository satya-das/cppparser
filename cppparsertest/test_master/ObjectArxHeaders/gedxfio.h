...
public:
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeCurveBoundary&);
	GE_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGePosition2d&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGePointOnCurve2d&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeExternalCurve2d&);
	GE_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeCubicSplineCurve2d&);
	GE_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeNurbCurve2d&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeCompositeCurve2d&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeOffsetCurve2d&);
	...
	GE_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeCubicSplineCurve3d&);
	GE_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeNurbCurve3d&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeCompositeCurve3d&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeCone&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeCylinder&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeTorus&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeExternalSurface&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeOffsetSurface&);
	GE_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeNurbSurface&);
	GE_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeExternalBoundedSurface&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus outFields(AcDbDxfFiler*, const AcGeSphere&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeCurveBoundary&);
	GE_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGePosition2d&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGePointOnCurve2d&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeExternalCurve2d&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeOffsetCurve2d&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeCompositeCurve3d&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeExternalCurve3d&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeExternalSurface&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeOffsetSurface&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeSphere&);
	...
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeCurveCurveInt2d&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeCurveCurveInt3d&);
	GX_DLLEXPIMPORT static Acad::ErrorStatus inFields(AcDbDxfFiler*, AcGeEllipCone&);
