...
public:
  AcDbAttributeDefinition();
  AcDbAttributeDefinition(const AcGePoint3d& position, const ACHAR* text, const ACHAR* tag, const ACHAR* prompt, AcDbObjectId style = AcDbObjectId::kNull);
  ~AcDbAttributeDefinition();
...
public:
  ...
  Acad::ErrorStatus openAttribute(AcDbAttribute*&, AcDbObjectId, AcDb::OpenMode, bool openErasedOne = false);
...
public:
  AcDbMInsertBlock();
  AcDbMInsertBlock(const AcGePoint3d& position, AcDbObjectId blockTableRec, Adesk::UInt16 columns, Adesk::UInt16 rows, double colSpacing, double rowSpacing);
  ~AcDbMInsertBlock();
...
public:
  ...
  Acad::ErrorStatus insertVertexAt(AcDbObjectId& newVertId, const AcDbObjectId& indexVertId, AcDb3dPolylineVertex* pNewVertex);
  Acad::ErrorStatus openVertex(AcDb3dPolylineVertex*&, AcDbObjectId vertId, AcDb::OpenMode, bool openErasedOne = false);
  Acad::ErrorStatus openSequenceEnd(AcDbSequenceEnd*&, AcDb::OpenMode);
  AcDbObjectIterator* vertexIterator() const;
protected:
    // AcDbEntity overrides
...
public:
  AcDbFace();
  AcDbFace(const AcGePoint3d& pt0, const AcGePoint3d& pt1, const AcGePoint3d& pt2, const AcGePoint3d& pt3, Adesk::Boolean e0vis = Adesk::kTrue, Adesk::Boolean e1vis = Adesk::kTrue, Adesk::Boolean e2vis = Adesk::kTrue, Adesk::Boolean e3vis = Adesk::kTrue);
  AcDbFace(const AcGePoint3d& pt0, const AcGePoint3d& pt1, const AcGePoint3d& pt2, Adesk::Boolean e0vis = Adesk::kTrue, Adesk::Boolean e1vis = Adesk::kTrue, Adesk::Boolean e2vis = Adesk::kTrue, Adesk::Boolean e3vis = Adesk::kTrue);
  ~AcDbFace();
...
public:
  ...
  Acad::ErrorStatus openVertex(AcDbVertex*&, AcDbObjectId subObjId, AcDb::OpenMode, bool openErasedOne = false);
  Acad::ErrorStatus openSequenceEnd(AcDbSequenceEnd*&, AcDb::OpenMode);
  AcDbObjectIterator* vertexIterator() const;
protected:
  virtual Acad::ErrorStatus subGetClassID(CLSID* pClsid) const override;
...
public:
  AcDbPolygonMesh();
  AcDbPolygonMesh(AcDb::PolyMeshType pType, Adesk::Int16 mSize, Adesk::Int16 nSize, const AcGePoint3dArray& vertices, Adesk::Boolean mClosed = Adesk::kTrue, Adesk::Boolean nClosed = Adesk::kTrue);
  ~AcDbPolygonMesh();
