...
class AcRxResourceInstance : public Pimpl::ApiPart<AcHeapOperators, Autodesk::AutoCAD::PAL::AcRxResourceInstanceImp>
{
public:
  ...
  ACBASE_PORT bool loadDataResource(Adesk::Int32 id, unsigned long& resourceSize, const void*& data) const;
    /// <summary>
  ...
  ACBASE_PORT void freeDataResource(const void*& data) const;
    /// <summary>
