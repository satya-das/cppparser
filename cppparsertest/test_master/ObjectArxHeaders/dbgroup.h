...
///
	...
	ACDBCORE2D_PORT Acad::ErrorStatus insertAt(Adesk::UInt32 idx, const AcDbObjectIdArray& ids);
	...
	ACDBCORE2D_PORT Acad::ErrorStatus removeAt(Adesk::UInt32 idx, const AcDbObjectIdArray& ids);
	Acad::ErrorStatus replace(AcDbObjectId oldId, AcDbObjectId newId);
	Acad::ErrorStatus transfer(Adesk::UInt32 fromIndex, Adesk::UInt32 toIndex, Adesk::UInt32 numItems);
