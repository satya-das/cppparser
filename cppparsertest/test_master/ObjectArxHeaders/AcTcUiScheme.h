...
public:
	...
	BOOL FindPalette(const AcTcCatalogItem* pItem, CAcTcUiToolPalette** ppToolPalette, CAcTcUiToolPaletteSet** ppToolPaletteSet) const;
	BOOL FindPalette(const GUID& itemId, CAcTcUiToolPalette** ppToolPalette) const;
	BOOL FindPalette(const GUID& itemId, CAcTcUiToolPalette** ppToolPalette, CAcTcUiToolPaletteSet** ppToolPaletteSet) const;
