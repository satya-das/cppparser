...
public:
    ...
    ///
	Acad::ErrorStatus setStartEdgeContinuity(Adesk::Int16 value, const AcString& expression = AcString(), const AcString& evaluatorId = AcString());
    /// <summary><para> 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
	Acad::ErrorStatus setEndEdgeContinuity(Adesk::Int16 value, const AcString& expression = AcString(), const AcString& evaluatorId = AcString());
    /// <summary><para> 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
	Acad::ErrorStatus setStartEdgeBulge(double value, const AcString& expression = AcString(), const AcString& evaluatorId = AcString());
    /// <summary><para> 
    /// Get bulge factor of end profile and its possible expression
    /// </para><para>
    /// the same parameter can be accessed through class AcDbAssocAction by calling method 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
	Acad::ErrorStatus setEndEdgeBulge(double value, const AcString& expression = AcString(), const AcString& evaluatorId = AcString());
    /// <summary> 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
	Acad::ErrorStatus getContinuityGripPoints(AcGePoint3d& startEdgePt, AcGePoint3d& endEdgePt) const;
    /// <summary> 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
	Acad::ErrorStatus getProfiles(AcDbLoftProfile*& pStartProfile, AcDbLoftProfile*& pEndProfile) const;
    /// <summary> 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
	static Acad::ErrorStatus createInstance(const AcDbObjectId& resultingSurfaceId, const AcDbLoftProfile* startProfile, const AcDbLoftProfile* endProfile, const AcDbBlendOptions& blendOptions, bool bEnabled, AcDbObjectId& createdActionId);
};
#pragma  pack (pop)
