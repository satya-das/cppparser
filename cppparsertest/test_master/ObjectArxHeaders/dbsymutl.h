  ...
  class Services  
{
  public:
    ...
    virtual Acad::ErrorStatus repairPreExtendedSymbolName(ACHAR*& pNewName, const ACHAR* oldName, bool allowVerticalBar) const = 0;
    virtual Acad::ErrorStatus repairSymbolName(ACHAR*& pNewName, const ACHAR* oldName, bool allowVerticalBar) const = 0;
    ...
    virtual bool getMaxSymbolNameLength(size_t& maxLength, size_t& maxSize, bool isNewName, bool compatibilityMode) const = 0;
    virtual Acad::ErrorStatus getPathNameFromSymbolName(ACHAR*& pPathName, const ACHAR* symbolName, const ACHAR* extensions) const = 0;
    virtual Acad::ErrorStatus getSymbolNameFromPathName(ACHAR*& pSymbolName, const ACHAR* pathName, const ACHAR* extensions) const = 0;
    virtual Acad::ErrorStatus preValidateSymbolName(ACHAR*& pSymbolName, bool preserveCase) const = 0;
    virtual Acad::ErrorStatus validateCompatibleSymbolName(const ACHAR* name, bool isNewName, bool allowVerticalBar, bool compatibilityMode) const = 0;
  };
