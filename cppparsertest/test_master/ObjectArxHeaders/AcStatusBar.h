...
public:
	...
	SB_DEPRECATED virtual BOOL CustomizeMenu(AcStatusBarType nType, CMenu* pMenu, UINT nStartCmdId, UINT nEndCmdId);
	SB_DEPRECATED virtual BOOL InvokeMenuCommand(AcStatusBarType nType, UINT nCmdId);
};
#	pragma  pack (pop)
#endif
